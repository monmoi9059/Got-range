var BallRenderer = {
    ...
    function drawPlayer(p) {
        ...
        if (isSitting) {
             ...
             lKneeX = p.x - (hipX + 12*s*stanceMod*spreadScale); lKneeY = p.y - 5*s;
             rKneeX = p.x + (hipX + 12*s*stanceMod*spreadScale); rKneeY = p.y - 5*s;
             ...
             lKneeX = p.x - (hipX + 7*s*stanceMod*spreadScale); lKneeY = p.y - legLen * 0.3;
             rKneeX = p.x + (hipX + 7*s*stanceMod*spreadScale); rKneeY = p.y - legLen * 0.3;
             // Feet slightly wider than hips
             lFootX = p.x - (hipX + 2*s*stanceMod*spreadScale); lFootY = p.y;
             rFootX = p.x + (hipX + 2*s*stanceMod*spreadScale); rFootY = p.y;
        } else {
             // Standing
             const baseKneeY = p.y - (legLen * 0.5);
             // Knees aligned with hips generally, slightly out
             lKneeX = p.x - (hipX + 1*s*stanceMod*spreadScale); lKneeY = baseKneeY;
             rKneeX = p.x + (hipX + 1*s*stanceMod*spreadScale); rKneeY = baseKneeY;
