...
var BallRenderer = {
    ...
    function resizeGame() {
        ...
        // Set Physical Resolution (Capped at 1920px max dimension)
        const MAX_DIM = 1920;
        let w = winW * dpr;
        let h = winH * dpr;
    ...
    var PlayerRenderer = {
        ...
        const drawSegmentedArm = (sx, sy, isRight, angle1, angle2, angle1_z, angle2_z) => {
            ...
            if (drawMode === 'long_sleeve') {
                 ...
                 drawContinuousLimb({x:sx,y:sy}, elbow, wrist, upperStartW, upperEndW, foreEndW, thisUpperColor, s, isFurry && (thisUpperColor === furColor), seedBase);
            }
                 ...
                 // Draw short segment
                 drawContinuousLimb({x:sx,y:sy}, sleeveEnd, sleeveEnd, sleeveW, sleeveW*0.9, sleeveW*0.9, thisUpperColor, s, false, 0);
            }
            else { // Skin
