    ...
    var HAIRSTYLES = [
        ...
        // --- UNIVERSAL / SHORT ---
        { id: 'bald_clean', name: 'Bald Clean', cost: 0 },
        { id: 'bald_stubble', name: 'Bald Stubble', cost: 0 },
        { id: 'buzz_cut', name: 'Buzz Cut', cost: 0 },
        { id: 'fade_low', name: 'Fade Low', cost: 0 },
        { id: 'fade_high', name: 'Fade High', cost: 0 },

        // --- TEXTURED / AFRO / BRAIDS (Black Styles) ---
        { id: 'afro_small', name: 'Afro Small', cost: 0 },
        { id: 'afro_medium', name: 'Afro Medium', cost: 0 },
        { id: 'afro_large', name: 'Afro Large', cost: 0 },
        { id: 'curls_tight', name: 'Curls Tight', cost: 0 },
        { id: 'cornrows', name: 'Cornrows', cost: 0 },
        { id: 'cornrows_tied', name: 'Cornrows Tied', cost: 0 },
        { id: 'braids_short', name: 'Braids Short', cost: 0 },
        { id: 'braids_long', name: 'Braids Long', cost: 0 },
        { id: 'braids_bun', name: 'Braids Bun', cost: 0 },
        { id: 'dreads_short', name: 'Dreads Short', cost: 0 },
        { id: 'dreads_long', name: 'Dreads Long', cost: 0 },
        { id: 'dreads_tied', name: 'Dreads Tied', cost: 0 },
        { id: 'flat_top', name: 'Flat Top', cost: 0 },

        // --- STRAIGHT / WAVY (White/General Styles) ---
        { id: 'pompadour', name: 'Pompadour', cost: 0 },
        { id: 'slick_back', name: 'Slick Back', cost: 0 },
        { id: 'side_part', name: 'Side Part', cost: 0 },
        { id: 'man_bun', name: 'Man Bun', cost: 0 },
        { id: 'top_knot', name: 'Top Knot', cost: 0 },
        { id: 'surfer_flow', name: 'Surfer Flow', cost: 0 },
        { id: 'shoulder_length', name: 'Shoulder Length', cost: 0 },
        { id: 'messy_top', name: 'Messy Top', cost: 0 }
    ];
