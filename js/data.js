    ...
    var SKINS_DB = [
        ...
        { id: 'human_wall', animal: 'human', name: 'Speedy', shortsPattern: 'wizards', jerseyName: 'SPEEDY', cost: 5000, heightScale: 1.085, widthScale: 0.9, jerseyColor: '#FFF', shortsColor: '#FFF', sideStripesColor: '#002B5C', trimColor: '#E31837', number: '2', numberColor: '#E31837', skinTone: '#5c3a21', hairStyle: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', sleeveRight: '#E31837', beard: true },
        { id: 'human_wall_alt', animal: 'human', name: 'Capital Red', jerseyName: 'D.C.', cost: 5000, heightScale: 1.085, widthScale: 0.9, jerseyColor: '#E31837', shortsColor: '#E31837', sideStripesColor: '#FFF', trimColor: '#002B5C', number: '2', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'cornrows_straight', hairColor: '#000', socksColor: '#FFF', shoesColor: '#002B5C', beard: true },
        { id: 'human_wall_rookie', animal: 'human', name: 'Rookie Wall', jerseyName: 'ROOKIE', cost: 10000, heightScale: 1.085, widthScale: 0.9, jerseyColor: '#002B5C', shortsColor: '#002B5C', trimColor: '#C4A006', number: '2', numberColor: '#C4A006', skinTone: '#5c3a21', hairStyle: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#C4A006', sleeveRight: '#FFF' },
        { id: 'human_lebron', animal: 'human', name: 'The King', jerseyName: 'THE KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '23', numberColor: '#552583', skinTone: '#4a3020', hairStyle: 'buzz_cut', headAccessory: 'headband', hairColor: '#000', headbandColor: '#552583', hatColor: '#552583', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#FDB927', socksColor: '#FFF', shoesColor: '#552583', tattoos: true, beard: true },
        { id: 'human_lebron_alt', animal: 'human', name: 'Heatles', jerseyName: 'KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#E31837', number: '6', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'buzz_cut', headAccessory: 'headband', hairColor: '#000', headbandColor: '#E31837', hatColor: '#E31837', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#000', socksColor: '#000', shoesColor: '#E31837', tattoos: true, beard: true },
        { id: 'human_lebron_cavs', animal: 'human', name: 'Believeland', jerseyName: 'KING', cost: 30000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#6F263D', shortsColor: '#6F263D', trimColor: '#FFB81C', number: '23', numberColor: '#FFB81C', skinTone: '#4a3020', hairStyle: 'buzz_cut', headAccessory: 'headband', hairColor: '#000', headbandColor: '#FFB81C', hatColor: '#FFB81C', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#6F263D', socksColor: '#000', shoesColor: '#000', tattoos: true, beard: true },
        { id: 'human_kobe8', animal: 'human', name: 'Frobe', jerseyName: 'FROBE', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '8', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'afro_mini', afroSize: 1.1, hairStyle2: 'short_afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#111', beard: true },
        { id: 'human_kobe8_alt', animal: 'human', name: 'Showtime 8', jerseyName: 'MAMBA', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#552583', shortsColor: '#552583', sideStripesColor: '#FDB927', number: '8', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro_mini', afroSize: 1.1, hairStyle2: 'short_afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_kobe24', animal: 'human', name: 'Black Mamba', jerseyName: 'MAMBA', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#552583', number: '24', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'bald', hairStyle2: 'buzz_cut', hairColor: '#000', sleeveRight: '#FFF', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_kobe24_alt', animal: 'human', name: 'Mamba Forever', jerseyName: 'EIGHT', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#000', shortsColor: '#000', trimColor: '#FDB927', number: '24', numberColor: '#FDB927', skinTone: '#5c3a21', hairStyle: 'bald', hairStyle2: 'buzz_cut', hairColor: '#000', sleeveRight: '#000', socksColor: '#000', shoesColor: '#FDB927' },
        { id: 'human_curry', animal: 'human', name: 'Chef Curry', jerseyName: 'CHEF', cost: 30000, heightScale: 1.070, widthScale: 0.85, armWidthScale: 0.9, legWidthScale: 0.9, jerseyColor: '#1D428A', shortsColor: '#1D428A', trimColor: '#FFC72C', number: '30', numberColor: '#FFC72C', skinTone: '#dcb98a', hairStyle: 'afro_mini', hairStyle2: 'cornrows_straight', hairColor: '#000', jerseyType: 'tshirt', socksColor: '#FFF', shoesColor: '#FFC72C', beard: true },
        { id: 'human_curry_alt', animal: 'human', name: 'The City', jerseyName: 'CHEF', cost: 30000, heightScale: 1.070, widthScale: 0.85, armWidthScale: 0.9, legWidthScale: 0.9, jerseyColor: '#FDB927', shortsColor: '#FDB927', trimColor: '#1D428A', number: '30', numberColor: '#1D428A', skinTone: '#dcb98a', hairStyle: 'afro_mini', hairStyle2: 'cornrows_straight', hairColor: '#000', jerseyType: 'tshirt', socksColor: '#1D428A', shoesColor: '#FDB927', beard: true },
        { id: 'human_magic', animal: 'human', name: 'Magic', jerseyName: 'MAGIC', cost: 30000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '32', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        { id: 'human_magic_alt', animal: 'human', name: 'Purple Magic', jerseyName: 'MAGIC', cost: 30000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#552583', shortsColor: '#552583', sideStripesColor: '#FDB927', number: '32', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'buzz_cut', hairColor: '#000', socksColor: '#FDB927', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_drj', animal: 'human', name: 'The Doctor', jerseyName: 'DOCTOR', cost: 35000, heightScale: 1.140, widthScale: 0.9, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#ED174C', number: '32', numberColor: '#ED174C', skinTone: '#5c3a21', hairStyle: 'afro_classic', afroSize: 1.5, hairColor: '#000', socksColor: '#FFF', shoesColor: '#ED174C', shortsLength: 'short' },
        { id: 'human_drj_alt', animal: 'human', name: 'ABA Star', jerseyName: 'DOCTOR', cost: 35000, heightScale: 1.140, widthScale: 0.9, jerseyColor: '#00285E', shortsColor: '#00285E', trimColor: '#E31837', number: '32', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro_classic', afroSize: 1.5, hairColor: '#000', socksColor: '#FFF', shoesColor: '#E31837', shortsLength: 'short' },
        { id: 'human_wilt', animal: 'human', name: 'The Stilt', jerseyName: 'STILT', cost: 40000, heightScale: 1.230, widthScale: 0.95, jerseyColor: '#552583', shortsColor: '#552583', sideStripesColor: '#FDB927', number: '13', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'buzz_cut', headAccessory: 'headband', hairColor: '#000', headbandColor: '#FDB927', hatColor: '#FDB927', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short', beard: true },
        ...
        { id: 'human_mj', animal: 'human', name: 'The G.O.A.T.', jerseyName: 'G.O.A.T.', shortsPattern: 'bulls', cost: 50000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#CE1141', trimColor: '#000', number: '23', numberColor: '#000', skinTone: '#3e271a', hairStyle: 'bald', hairStyle2: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#CE1141' },
        { id: 'human_mj_alt', animal: 'human', name: 'Black Pinstripe', jerseyName: 'G.O.A.T.', cost: 50000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#000', shortsColor: '#000', pinstripesColor: '#CE1141', number: '23', numberColor: '#CE1141', skinTone: '#3e271a', hairStyle: 'bald', hairStyle2: 'fade_high', hairColor: '#000', socksColor: '#000', shoesColor: '#FFF' },
        { id: 'human_mj_wiz', animal: 'human', name: 'D.C. GOAT', jerseyName: 'G.O.A.T.', cost: 40000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#002B5C', shortsColor: '#002B5C', trimColor: '#C4A006', number: '23', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'bald', hairStyle2: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_bird', animal: 'human', name: 'Larry Legend', jerseyName: 'LEGEND', cost: 40000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '33', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#e3c179', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_bird_alt', animal: 'human', name: 'Celtics Home', jerseyName: 'LEGEND', cost: 40000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#007A33', number: '33', numberColor: '#007A33', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#e3c179', socksColor: '#007A33', shoesColor: '#000', shortsLength: 'short' },
        ...
        { id: 'human_duncan', animal: 'human', name: 'Big Fundamental', jerseyName: 'FUNDAMENTAL', cost: 35000, heightScale: 1.200, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', trimColor: '#C4CED4', number: '21', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_duncan_alt', animal: 'human', name: 'Silver Spur', jerseyName: 'TIMMY', cost: 35000, heightScale: 1.200, widthScale: 0.95, jerseyColor: '#C4CED4', shortsColor: '#C4CED4', trimColor: '#000', number: '21', numberColor: '#000', skinTone: '#5c3a21', hairStyle: 'buzz_cut', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_rodman', animal: 'human', name: 'The Worm', jerseyName: 'WORM', shortsPattern: 'bulls', cost: 30000, heightScale: 1.140, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#000', trimColor: '#000', number: '91', numberColor: '#000', skinTone: '#3e271a', hairStyle: 'rodman_dye', hairColor: '#00FF00', hairColor2: '#FFD700', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short', tattoos: true },
        { id: 'human_rodman_alt', animal: 'human', name: 'Bad Boy', jerseyName: 'WORM', cost: 30000, heightScale: 1.140, widthScale: 0.9, jerseyColor: '#00519E', shortsColor: '#00519E', trimColor: '#E31837', number: '10', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'rodman_dye', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        ...
        { id: 'human_dirk', animal: 'human', name: 'German Jesus', jerseyName: 'GERMAN', cost: 30000, heightScale: 1.215, widthScale: 0.92, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '41', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#dcb98a', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_dirk_alt', animal: 'human', name: 'Retro Mav', jerseyName: 'DIRK', cost: 30000, heightScale: 1.215, widthScale: 0.92, jerseyColor: '#007A33', shortsColor: '#007A33', sideStripesColor: '#00538C', number: '41', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#dcb98a', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_giannis', animal: 'human', name: 'Greek Freak', jerseyName: 'FREAK', cost: 25000, heightScale: 1.200, widthScale: 0.98, jerseyColor: '#00471B', shortsColor: '#00471B', sideStripesColor: '#EEE1C6', number: '34', numberColor: '#EEE1C6', skinTone: '#4a3020', hairStyle: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_giannis_alt', animal: 'human', name: 'Cream City', jerseyName: 'FREAK', cost: 25000, heightScale: 1.200, widthScale: 0.98, jerseyColor: '#EEE1C6', shortsColor: '#EEE1C6', sideStripesColor: '#00471B', number: '34', numberColor: '#00471B', skinTone: '#4a3020', hairStyle: 'fade_high', hairColor: '#000', socksColor: '#00471B', shoesColor: '#FFF' },
        { id: 'human_joker', animal: 'human', name: 'The Joker', jerseyName: 'JOKER', cost: 25000, heightScale: 1.200, widthScale: 1.1, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#0E2240', shortsColor: '#0E2240', trimColor: '#FEC524', number: '15', numberColor: '#FEC524', skinTone: '#f0d5be', hairStyle: 'buzz_cut', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_joker_alt', animal: 'human', name: 'Rainbow', jerseyName: 'JOKER', cost: 25000, heightScale: 1.200, widthScale: 1.1, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#FFF', shortsColor: '#FFF', sideStripesColor: '#FF0000', number: '15', numberColor: '#FEC524', skinTone: '#f0d5be', hairStyle: 'buzz_cut', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_luka', animal: 'human', name: 'Luka Magic', jerseyName: 'MAGIC', cost: 25000, heightScale: 1.140, widthScale: 1.0, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '77', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'fade_high', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#FFF', beard: true },
        { id: 'human_luka_alt', animal: 'human', name: 'Matador', jerseyName: 'LUKA', cost: 25000, heightScale: 1.140, widthScale: 1.0, jerseyColor: '#FFF', shortsColor: '#FFF', sideStripesColor: '#00C1D4', number: '7', numberColor: '#00C1D4', skinTone: '#f0d5be', hairStyle: 'fade_high', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#00C1D4', beard: true },
        { id: 'human_kd', animal: 'human', name: 'Slim Reaper', jerseyName: 'REAPER', cost: 30000, heightScale: 1.200, widthScale: 0.85, armWidthScale: 0.8, legWidthScale: 0.8, jerseyColor: '#1D1160', shortsColor: '#1D1160', sideStripesColor: '#E56020', number: '35', numberColor: '#E56020', skinTone: '#3e271a', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#1D428A', beard: true },
        { id: 'human_kd_alt', animal: 'human', name: 'SuperSonics', jerseyName: 'SLIM', cost: 30000, heightScale: 1.200, widthScale: 0.85, armWidthScale: 0.8, legWidthScale: 0.8, jerseyColor: '#00653A', shortsColor: '#00653A', sideStripesColor: '#FFC200', number: '35', numberColor: '#FFC200', skinTone: '#3e271a', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFC200', beard: true },
        { id: 'human_harden', animal: 'human', name: 'The Beard', jerseyName: 'BEARD', cost: 25000, heightScale: 1.110, widthScale: 0.95, jerseyColor: '#CE1141', shortsColor: '#CE1141', sideStripesColor: '#FFF', number: '13', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'mohawk_burst', hairStyle2: 'cornrows_straight', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true, beardBig: true, beardColor: '#000' },
        { id: 'human_harden_alt', animal: 'human', name: 'Brooklyn', jerseyName: 'BEARD', cost: 25000, heightScale: 1.110, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#FFF', number: '13', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'mohawk_burst', hairStyle2: 'cornrows_straight', hairColor: '#000', beard: true, beardBig: true, beardColor: '#000', socksColor: '#000', shoesColor: '#FFF' },
        ...
        { id: 'human_kareem_alt', animal: 'human', name: 'Bucks Cap', jerseyName: 'CAP', cost: 45000, heightScale: 1.245, widthScale: 0.88, jerseyColor: '#00471B', shortsColor: '#00471B', sideStripesColor: '#EEE1C6', number: '33', numberColor: '#EEE1C6', skinTone: '#4a3020', hairStyle: 'afro_classic', afroSize: 1.1, hairColor: '#000', socksColor: '#00471B', shoesColor: '#EEE1C6', shortsLength: 'short' },
        { id: 'human_russell', animal: 'human', name: 'Bill', jerseyName: 'BILL', cost: 50000, heightScale: 1.185, widthScale: 0.9, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '6', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro_classic', afroSize: 1.0, hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short', beard: true },
        { id: 'human_russell_alt', animal: 'human', name: 'Celtics Away', jerseyName: 'BILL', cost: 50000, heightScale: 1.185, widthScale: 0.9, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '6', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro_classic', afroSize: 1.0, hairColor: '#000', socksColor: '#000', shoesColor: '#000', shortsLength: 'short', beard: true },
        { id: 'human_jackie', animal: 'human', name: 'Semi Moon', jerseyName: 'MOON', cost: 500, heightScale: 1.1, widthScale: 1.0, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#FFA500', sideStripesColor: '#00CED1', number: '33', numberColor: '#00CED1', skinTone: '#ffe0bd', hairStyle: 'afro_classic', afroSize: 1.3, hairColor: '#5D4037', headAccessory: 'headband', hatColor: '#FFA500', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        ...
        { id: 'human_nash', animal: 'human', name: 'Captain Canada', cost: 35000, heightScale: 1.05, widthScale: 0.88, jerseyColor: '#1D1160', shortsColor: '#1D1160', sideStripesColor: '#E56020', number: '13', numberColor: '#E56020', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#6B4423', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_nash_alt', animal: 'human', name: 'Dallas', jerseyName: 'STEVE', cost: 35000, heightScale: 1.05, widthScale: 0.88, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '13', numberColor: '#B8C4CA', skinTone: '#f0d5be', hairStyle: 'long_layered', hairColor: '#6B4423', socksColor: '#000', shoesColor: '#FFF' },
        ...
        { id: 'human_zeke', animal: 'human', name: 'Zeke', cost: 35000, heightScale: 1.02, widthScale: 0.85, jerseyColor: '#006BB6', shortsColor: '#006BB6', sideStripesColor: '#ED174C', number: '11', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_zeke_alt', animal: 'human', name: 'Bad Boys', jerseyName: 'ZEKE', cost: 35000, heightScale: 1.02, widthScale: 0.85, jerseyColor: '#FFF', shortsColor: '#FFF', sideStripesColor: '#ED174C', number: '11', numberColor: '#ED174C', skinTone: '#5c3a21', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        ...
        { id: 'human_klaw', animal: 'human', name: 'The Klaw', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#C4CED4', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows_straight', hairStyle2: 'afro_mini', hairColor: '#000', socksColor: '#000', shoesColor: '#000', beard: true },
        { id: 'human_klaw_alt', animal: 'human', name: 'North', jerseyName: 'KLAW', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#CE1141', shortsColor: '#CE1141', sideStripesColor: '#000', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows_straight', hairStyle2: 'afro_mini', hairColor: '#000', socksColor: '#CE1141', shoesColor: '#000', beard: true },
        ...
        { id: 'human_sga', animal: 'human', name: 'SGA', cost: 30000, heightScale: 1.14, widthScale: 0.9, jerseyColor: '#007AC1', shortsColor: '#007AC1', sideStripesColor: '#EF3B24', number: '2', numberColor: '#EF3B24', skinTone: '#5c3a21', hairStyle: 'cornrows_straight', hairColor: '#000', headbandColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_sga_alt', animal: 'human', name: 'Canada', jerseyName: 'SHAI', cost: 30000, heightScale: 1.14, widthScale: 0.9, jerseyColor: '#CE1126', shortsColor: '#CE1126', sideStripesColor: '#FFF', number: '2', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'cornrows_straight', hairColor: '#000', headbandColor: '#CE1126', socksColor: '#FFF', shoesColor: '#000', beard: true },
        ...
        { id: 'human_kyrie', animal: 'human', name: 'Uncle Drew', cost: 30000, heightScale: 1.04, widthScale: 0.9, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '11', numberColor: '#FFF', skinTone: '#8d5524', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#000', shoesColor: '#000', beard: true },
        { id: 'human_kyrie_alt', animal: 'human', name: 'The Land', jerseyName: 'UNCLE DREW', cost: 30000, heightScale: 1.04, widthScale: 0.9, jerseyColor: '#6F263D', shortsColor: '#6F263D', sideStripesColor: '#FDB927', number: '2', numberColor: '#FDB927', skinTone: '#8d5524', hairStyle: 'afro_mini', hairColor: '#000', beard: true, socksColor: '#6F263D', shoesColor: '#FDB927' },
        { id: 'human_dame', animal: 'human', name: 'Dame Time', cost: 30000, heightScale: 1.04, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', pinstripesColor: '#CE1141', number: '0', numberColor: '#CE1141', skinTone: '#5c3a21', hairStyle: 'fade_high', hairColor: '#000', sleeveLeft: '#000', socksColor: '#000', shoesColor: '#000', tattoos: true, beard: true },
        { id: 'human_dame_alt', animal: 'human', name: 'Rip City', jerseyName: 'DAME', cost: 30000, heightScale: 1.04, widthScale: 0.95, jerseyColor: '#FFF', shortsColor: '#FFF', pinstripesColor: '#CE1141', number: '0', numberColor: '#CE1141', skinTone: '#5c3a21', hairStyle: 'fade_high', hairColor: '#000', sleeveLeft: '#FFF', socksColor: '#FFF', shoesColor: '#CE1141', tattoos: true, beard: true },
        { id: 'human_tatum', animal: 'human', name: 'Taco Jay', cost: 30000, heightScale: 1.18, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '0', numberColor: '#FFF', skinTone: '#dcb98a', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', tattoos: true, beard: true },
        { id: 'human_tatum_alt', animal: 'human', name: 'Duke', jerseyName: 'TACO JAY', cost: 30000, heightScale: 1.18, widthScale: 0.95, jerseyColor: '#003087', shortsColor: '#003087', trimColor: '#FFF', number: '0', numberColor: '#FFF', skinTone: '#dcb98a', hairStyle: 'buzz_cut', hairColor: '#000', beard: true, socksColor: '#FFF', shoesColor: '#000', tattoos: true },
        { id: 'human_process', animal: 'human', name: 'The Process', cost: 30000, heightScale: 1.25, widthScale: 1.1, jerseyColor: '#006BB6', shortsColor: '#006BB6', trimColor: '#ED174C', number: '21', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        ...
        { id: 'fake_link', animal: 'human', name: 'Elfe Héros', cost: 12000, heightScale: 1.0, widthScale: 0.95, jerseyType: 'link_tunic', jerseyColor: '#00A000', shortsColor: '#EEE', legType: 'tights', number: '', numberColor: '#000', skinTone: '#ffe0bd', hairStyle: 'long_layered', hairColor: '#FFD700', ears: 'elf', headAccessory: 'floppy_cap', hatColor: '#00A000', backProp: 'hero_gear', socksColor: '#EEE', shoesColor: '#3c2415' },
        { id: 'fake_kratos', animal: 'human', name: 'Spartiate', cost: 15000, heightScale: 1.15, widthScale: 1.2, jerseyType: 'none', shortsType: 'kilt', shortsColor: '#333', number: '', numberColor: '#000', skinTone: '#F0F0F0', hairStyle: 'bald', hairColor: '#333', pattern: 'spartan_tattoo', backProp: 'chaos_blades', headDetail: 'tattoo_stripe', socksColor: '#333', shoesColor: '#333', beard: true },
        { id: 'fake_zeus', animal: 'human', name: 'Dieu Tonnerre', cost: 20000, heightScale: 1.2, widthScale: 1.1, jerseyColor: '#FFF', shortsColor: '#FFF', number: '', numberColor: '#FFD700', skinTone: '#dcb98a', hairStyle: 'long_layered', hairColor: '#FFF', headAccessory: 'bandana_neck', hatColor: '#FFD700', shoesColor: '#FFD700', beard: true },

        // THE ANCHOR (Ron Burgundy Parody)
        { id: 'human_anchor', animal: 'human', name: 'The Anchor', cost: 500, heightScale: 1.06, widthScale: 1.05, jerseyColor: '#800020', shortsColor: '#800020', legType: 'pants', sleeveColor: '#800020', hairStyle: 'slicked_back', hairColor: '#5D4037', skinTone: '#f0d5be', shoesColor: '#333', pattern: 'suit_jacket', jerseyType: 'tshirt' },
        ...
        // NEW HUMANS
        { id: 'human_potter', animal: 'human', name: 'Sorcier Lunettes', cost: 15000, jerseyColor: '#111', shortsColor: '#111', legType: 'pants', skinTone: '#ffe0bd', backAccessory: 'cape', backColor: '#111', headAccessory: 'scarf', hatColor: '#8B0000', shoesColor: '#000', hairStyle: 'short_curly', hairColor: '#000' },
    ...
    var HAIRSTYLES = [
        ...
        { id: 'bald', name: 'Le Jordan', cost: 0 },
        { id: 'buzz_cut', name: 'Buzz Cut', cost: 500 },
        { id: 'fade_high', name: 'High Fade', cost: 1000 },
        { id: 'waves', name: '360 Waves', cost: 1000 },
        { id: 'cornrows_straight', name: 'Cornrows (AI)', cost: 1500 },
        { id: 'cornrows_designer', name: 'Cornrows Design', cost: 2000 },
        { id: 'braids_box', name: 'Box Braids', cost: 2000 },
        { id: 'dreads_long', name: 'Dreads Longues', cost: 2500 },
        { id: 'dreads_tied', name: 'Dreads Attachées', cost: 2500 },
        { id: 'afro_mini', name: 'Mini Fro (Kobe)', cost: 1000 },
        { id: 'afro_classic', name: 'Afro 70s (Dr. J)', cost: 2000 },
        { id: 'afro_blowout', name: 'Ben Fro', cost: 2500 },
        { id: 'flat_top', name: 'Flat Top', cost: 2000 },
        { id: 'mohawk_burst', name: 'Burst Fade Mohawk', cost: 2500 },
        { id: 'long_layered', name: 'Long (Nash/Dirk)', cost: 1500 },
        { id: 'slicked_back', name: 'Le Parrain', cost: 1500 },
        { id: 'top_knot', name: 'Top Knot', cost: 1500 },
        { id: 'rodman_dye', name: 'The Worm', cost: 5000 }
    ];
