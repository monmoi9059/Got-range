    ...
    var SKINS_DB = [
        ...
        { id: 'human_lebron', animal: 'human', name: 'The King', jerseyName: 'THE KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '23', numberColor: '#552583', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#552583', sleeveRight: '#FDB927', socksColor: '#FFF', shoesColor: '#552583', tattoos: true, beard: true },
        { id: 'human_lebron_alt', animal: 'human', name: 'Heatles', jerseyName: 'KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#E31837', number: '6', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#E31837', sleeveRight: '#000', socksColor: '#000', shoesColor: '#E31837', tattoos: true, beard: true },
        { id: 'human_lebron_cavs', animal: 'human', name: 'Believeland', jerseyName: 'KING', cost: 30000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#6F263D', shortsColor: '#6F263D', trimColor: '#FFB81C', number: '23', numberColor: '#FFB81C', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#FFB81C', sleeveRight: '#6F263D', socksColor: '#000', shoesColor: '#000', tattoos: true, beard: true },
        { id: 'human_kobe8', animal: 'human', name: 'Frobe', jerseyName: 'FROBE', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '8', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#111', beard: true },
        { id: 'human_kobe8_alt', animal: 'human', name: 'Showtime 8', jerseyName: 'MAMBA', cost: 30000, heightScale: 1.130, widthScale: 0.9, jerseyColor: '#552583', shortsColor: '#552583', sideStripesColor: '#FDB927', number: '8', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        ...
        { id: 'human_wilt', animal: 'human', name: 'The Stilt', jerseyName: 'STILT', cost: 40000, heightScale: 1.230, widthScale: 0.95, jerseyColor: '#552583', shortsColor: '#552583', sideStripesColor: '#FDB927', number: '13', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#FDB927', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short', beard: true },
        ...
        { id: 'human_bird', animal: 'human', name: 'Larry Legend', jerseyName: 'LEGEND', cost: 40000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '33', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'curly_long', hairColor: '#e3c179', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_bird_alt', animal: 'human', name: 'Celtics Home', jerseyName: 'LEGEND', cost: 40000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#007A33', number: '33', numberColor: '#007A33', skinTone: '#f0d5be', hairStyle: 'curly_long', hairColor: '#e3c179', socksColor: '#007A33', shoesColor: '#000', shortsLength: 'short' },
        ...
        { id: 'human_ai', animal: 'human', name: 'The Answer', jerseyName: 'ANSWER', cost: 35000, heightScale: 1.040, widthScale: 0.8, jerseyColor: '#000', shortsColor: '#000', trimColor: '#ED174C', number: '3', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'cornrows', hairColor: '#000', headbandColor: '#FFF', sleeveRight: '#000', socksColor: '#000', shoesColor: '#FFF', tattoos: true, beard: true },
        { id: 'human_ai_alt', animal: 'human', name: 'Powder Blue', jerseyName: 'ANSWER', cost: 35000, heightScale: 1.040, widthScale: 0.8, jerseyColor: '#418FDE', shortsColor: '#418FDE', trimColor: '#FDB927', number: '3', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'cornrows', hairColor: '#000', headbandColor: '#FFF', sleeveRight: '#418FDE', socksColor: '#FFF', shoesColor: '#FFF', tattoos: true, beard: true },
        ...
        { id: 'human_dirk', animal: 'human', name: 'German Jesus', jerseyName: 'GERMAN', cost: 30000, heightScale: 1.215, widthScale: 0.92, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '41', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'long', hairColor: '#dcb98a', socksColor: '#FFF', shoesColor: '#FFF' },
        ...
        { id: 'human_russell', animal: 'human', name: 'Bill', jerseyName: 'BILL', cost: 50000, heightScale: 1.185, widthScale: 0.9, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '6', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short', beard: true },
        { id: 'human_russell_alt', animal: 'human', name: 'Celtics Away', jerseyName: 'BILL', cost: 50000, heightScale: 1.185, widthScale: 0.9, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '6', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro', hairColor: '#000', socksColor: '#000', shoesColor: '#000', shortsLength: 'short', beard: true },
        { id: 'human_pip', animal: 'human', name: 'Pip', jerseyName: 'PIP', cost: 30000, heightScale: 1.160, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#CE1141', trimColor: '#000', number: '33', numberColor: '#000', skinTone: '#4a3020', hairStyle: 'flat_top', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        ...
        { id: 'human_klaw', animal: 'human', name: 'The Klaw', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#C4CED4', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows', hairColor: '#000', socksColor: '#000', shoesColor: '#000', beard: true },
        { id: 'human_klaw_alt', animal: 'human', name: 'North', jerseyName: 'KLAW', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#CE1141', shortsColor: '#CE1141', sideStripesColor: '#000', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows', hairColor: '#000', socksColor: '#CE1141', shoesColor: '#000', beard: true },
        ...
        { id: 'human_brow', animal: 'human', name: 'The Brow', cost: 30000, heightScale: 1.21, widthScale: 0.95, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '3', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'afro', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true, beardBig: true },
        { id: 'human_brow_alt', animal: 'human', name: 'NOLA', jerseyName: 'BROW', cost: 30000, heightScale: 1.21, widthScale: 0.95, jerseyColor: '#002B5C', shortsColor: '#002B5C', sideStripesColor: '#B4975A', number: '23', numberColor: '#B4975A', skinTone: '#5c3a21', hairStyle: 'afro', hairColor: '#000', beard: true, beardBig: true, socksColor: '#FFF', shoesColor: '#002B5C' },
        { id: 'human_brow_wiz', animal: 'human', name: 'The Trade', jerseyName: 'BROW', cost: 30000, heightScale: 1.21, widthScale: 0.95, jerseyColor: '#002B5C', shortsColor: '#002B5C', sideStripesColor: '#E31837', number: '23', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'afro', hairColor: '#000', beard: true, beardBig: true, socksColor: '#FFF', shoesColor: '#E31837' },
