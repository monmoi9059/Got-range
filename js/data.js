    ...
    var SKINS_DB = [
        ...
        { id: 'human_curry', animal: 'human', name: 'Chef Curry', jerseyName: 'CHEF', cost: 30000, heightScale: 1.070, widthScale: 0.85, armWidthScale: 0.9, legWidthScale: 0.9, jerseyColor: '#1D428A', shortsColor: '#1D428A', trimColor: '#FFC72C', number: '30', numberColor: '#FFC72C', skinTone: '#dcb98a', hairStyle: 'fade_chef', hairStyle2: 'cornrows_straight', hairColor: '#000', jerseyType: 'tshirt', socksColor: '#FFF', shoesColor: '#FFC72C', beard: true },
        { id: 'human_curry_alt', animal: 'human', name: 'The City', jerseyName: 'CHEF', cost: 30000, heightScale: 1.070, widthScale: 0.85, armWidthScale: 0.9, legWidthScale: 0.9, jerseyColor: '#FDB927', shortsColor: '#FDB927', trimColor: '#1D428A', number: '30', numberColor: '#1D428A', skinTone: '#dcb98a', hairStyle: 'fade_chef', hairStyle2: 'cornrows_straight', hairColor: '#000', jerseyType: 'tshirt', socksColor: '#1D428A', shoesColor: '#FDB927', beard: true },
        ...
        { id: 'human_duncan', animal: 'human', name: 'Big Fundamental', jerseyName: 'FUNDAMENTAL', cost: 35000, heightScale: 1.200, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', trimColor: '#C4CED4', number: '21', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'fade_retro', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_duncan_alt', animal: 'human', name: 'Silver Spur', jerseyName: 'TIMMY', cost: 35000, heightScale: 1.200, widthScale: 0.95, jerseyColor: '#C4CED4', shortsColor: '#C4CED4', trimColor: '#000', number: '21', numberColor: '#000', skinTone: '#5c3a21', hairStyle: 'fade_retro', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        ...
        { id: 'human_tmac', animal: 'human', name: 'T-Mac', jerseyName: 'T-MAC', cost: 25000, heightScale: 1.160, widthScale: 0.9, jerseyColor: '#007DC5', shortsColor: '#007DC5', pinstripesColor: '#C4CED4', number: '1', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'bald_clean', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_tmac_alt', animal: 'human', name: 'Houston', jerseyName: 'T-MAC', cost: 25000, heightScale: 1.160, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#CE1141', pinstripesColor: '#FFF', number: '1', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'bald_clean', hairColor: '#000', socksColor: '#CE1141', shoesColor: '#FFF' },
        { id: 'human_kg', animal: 'human', name: 'Big Ticket', jerseyName: 'TICKET', cost: 30000, heightScale: 1.200, widthScale: 0.88, jerseyColor: '#005083', shortsColor: '#005083', trimColor: '#78BE20', number: '21', numberColor: '#FFF', skinTone: '#2e1e16', hairStyle: 'bald_stubble', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_kg_alt', animal: 'human', name: 'Green Ticket', jerseyName: 'TICKET', cost: 30000, heightScale: 1.200, widthScale: 0.88, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '5', numberColor: '#FFF', skinTone: '#2e1e16', hairStyle: 'bald_stubble', hairColor: '#000', socksColor: '#000', shoesColor: '#000', beard: true },
        ...
        { id: 'human_sga', animal: 'human', name: 'SGA', cost: 30000, heightScale: 1.14, widthScale: 0.9, jerseyColor: '#007AC1', shortsColor: '#007AC1', sideStripesColor: '#EF3B24', number: '2', numberColor: '#EF3B24', skinTone: '#5c3a21', hairStyle: 'cornrows_braids', hairColor: '#000', headbandColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        { id: 'human_sga_alt', animal: 'human', name: 'Canada', jerseyName: 'SHAI', cost: 30000, heightScale: 1.14, widthScale: 0.9, jerseyColor: '#CE1126', shortsColor: '#CE1126', sideStripesColor: '#FFF', number: '2', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'cornrows_braids', hairColor: '#000', headbandColor: '#CE1126', socksColor: '#FFF', shoesColor: '#000', beard: true },
        ...
        { id: 'human_tatum', animal: 'human', name: 'Taco Jay', cost: 30000, heightScale: 1.18, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '0', numberColor: '#FFF', skinTone: '#dcb98a', hairStyle: 'curls_textured', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', tattoos: true, beard: true },
        ...
        { id: 'human_process', animal: 'human', name: 'The Process', cost: 30000, heightScale: 1.25, widthScale: 1.1, jerseyColor: '#006BB6', shortsColor: '#006BB6', trimColor: '#ED174C', number: '21', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'curls_textured', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000', beard: true },
        ...
        { id: 'human_potter', animal: 'human', name: 'Sorcier Lunettes', cost: 15000, jerseyColor: '#111', shortsColor: '#111', legType: 'pants', skinTone: '#ffe0bd', backAccessory: 'cape', backColor: '#111', headAccessory: 'scarf', hatColor: '#8B0000', shoesColor: '#000', hairStyle: 'crew_messy', hairColor: '#000' },
    ...
    var HAIRSTYLES = [
        ...
        { id: 'bald_stubble', name: 'Stubble', cost: 250 },
        { id: 'buzz_cut', name: 'Buzz Cut', cost: 500 },
        { id: 'buzz_colored', name: 'The Worm', cost: 5000 },
        { id: 'fade_retro', name: '80s Fade', cost: 1000 },
        { id: 'fade_box', name: 'Flat Top', cost: 1500 },
        { id: 'fade_high', name: 'High Fade', cost: 1500 },
        { id: 'fade_king', name: 'King\'s Crown', cost: 2500 },
        { id: 'fade_chef', name: 'Chef Fade', cost: 2000 },
        { id: 'curls_textured', name: 'Textured Curls', cost: 2000 },
        { id: 'afro_mini', name: 'Mini Fro', cost: 1500 },
        { id: 'afro_70s', name: 'Classic Afro', cost: 2500 },
        { id: 'cornrows_straight', name: 'The Answer', cost: 3000 },
        { id: 'cornrows_braids', name: 'Braided Rows', cost: 2500 },
        { id: 'braids_box', name: 'Box Braids', cost: 2500 },
        { id: 'dreads_long', name: 'Dreads', cost: 3000 },
        { id: 'dreads_tied', name: 'Tied Dreads', cost: 3000 },
        { id: 'mullet_80s', name: 'Legend Mullet', cost: 3500 },
        { id: 'long_flow', name: 'Euro Flow', cost: 2000 },
        { id: 'slicked_back', name: 'The Anchor', cost: 2000 },
        { id: 'mohawk_fade', name: 'Beard & Hawk', cost: 2500 },
        { id: 'top_knot', name: 'Top Knot', cost: 2000 },
        { id: 'crew_messy', name: 'Messy Crew', cost: 1000 }
    ];
