    ...
    var SKINS_DB = [
        ...
        { id: 'human_lebron', animal: 'human', name: 'The King', jerseyName: 'THE KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '23', numberColor: '#552583', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#552583', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#FDB927', socksColor: '#FFF', shoesColor: '#552583', tattoos: true, beard: true },
        { id: 'human_lebron_alt', animal: 'human', name: 'Heatles', jerseyName: 'KING', cost: 25000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#E31837', number: '6', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#E31837', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#000', socksColor: '#000', shoesColor: '#E31837', tattoos: true, beard: true },
        { id: 'human_lebron_cavs', animal: 'human', name: 'Believeland', jerseyName: 'KING', cost: 30000, heightScale: 1.170, widthScale: 1.0, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#6F263D', shortsColor: '#6F263D', trimColor: '#FFB81C', number: '23', numberColor: '#FFB81C', skinTone: '#4a3020', hairStyle: 'headband', hairColor: '#000', headbandColor: '#FFB81C', hairStyle2: 'bald', headbandColor2: null, sleeveRight: '#6F263D', socksColor: '#000', shoesColor: '#000', tattoos: true, beard: true },
        ...
        { id: 'human_klaw', animal: 'human', name: 'The Klaw', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#C4CED4', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows', hairStyle2: 'afro', hairColor: '#000', socksColor: '#000', shoesColor: '#000', beard: true },
        { id: 'human_klaw_alt', animal: 'human', name: 'North', jerseyName: 'KLAW', cost: 35000, heightScale: 1.15, widthScale: 1.0, jerseyColor: '#CE1141', shortsColor: '#CE1141', sideStripesColor: '#000', number: '2', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'cornrows', hairStyle2: 'afro', hairColor: '#000', socksColor: '#CE1141', shoesColor: '#000', beard: true },
    ...
    var HAIRSTYLES = [
        ...
        { id: 'bun_low', name: 'Chignon Bas', cost: 1000 },
        { id: 'top_knot', name: 'Top Knot', cost: 1000 },
        { id: 'ponytail_high', name: 'Queue de Cheval Haute', cost: 1000 },
        { id: 'ponytail_low', name: 'Queue de Cheval Basse', cost: 1000 },
        { id: 'pigtails', name: 'Couettes', cost: 1500 },
        { id: 'space_buns', name: 'Double Chignons', cost: 1500 },
        { id: 'mullet_modern', name: 'Mullet Moderne', cost: 1500 },
        { id: 'undercut', name: 'Undercut', cost: 1500 },
        { id: 'slicked_back', name: 'Plaqué Arrière', cost: 1000 },
        { id: 'caesar', name: 'Coupe César', cost: 500 },
        { id: 'buzz_cut', name: 'Coupe Militaire', cost: 500 },
        { id: 'bowl_cut', name: 'Coupe au Bol', cost: 500 },
        { id: 'faux_hawk', name: 'Faux Hawk', cost: 1000 },
        { id: 'shag', name: 'Coupe Shag', cost: 1500 },
        { id: 'bob', name: 'Carré Court', cost: 1000 },
        { id: 'pixie', name: 'Pixie Cut', cost: 1000 },
        { id: 'beehive', name: 'Choucroute', cost: 2000 },
        { id: 'emo_fringe', name: 'Mèche Emo', cost: 1500 },
        { id: 'liberty_spikes', name: 'Piques Liberté', cost: 2000 },
        { id: 'clown', name: 'Clown', cost: 2000 },
        { id: 'monk', name: 'Moine', cost: 2000 },
        { id: 'samurai_bun', name: 'Chonmage', cost: 2000 },
        { id: 'dread_bun', name: 'Chignon Dreads', cost: 2000 },
        { id: 'long_straight', name: 'Long Lisse', cost: 1500 },
        { id: 'long_wavy', name: 'Long Ondulé', cost: 1500 },
