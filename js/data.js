    ...
    var SKINS_DB = [
        ...
        // NEW ANIMALS
        { id: 'skin_elephant', animal: 'elephant', name: 'Éléphant', cost: 5000, furColor: '#808080', headDetail: 'trunk' },
        { id: 'skin_giraffe', animal: 'giraffe', name: 'Girafe', cost: 5000, furColor: '#DAA520', pattern: 'spots', spotColor: '#8B4513' },
        { id: 'skin_zebra', animal: 'zebra', name: 'Zèbre', cost: 5000, furColor: '#FFF', pattern: 'tiger_stripes', spotColor: '#000' },
        { id: 'skin_dino', animal: 'dino', name: 'T-Rex', cost: 10000, furColor: '#228B22', tailType: 'dino' },
        { id: 'skin_chicken', animal: 'chicken', name: 'Poulet', cost: 2500, furColor: '#FFF', tailType: 'chicken', headDetail: 'comb' },

        // NBA LEGENDS (NEW)
        { id: 'human_pip', animal: 'human', name: 'Robin', jerseyName: 'ROBIN', cost: 30000, heightScale: 1.16, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#CE1141', trimColor: '#000', number: '33', numberColor: '#000', skinTone: '#3e271a', hairStyle: 'fade_box', hairColor: '#000', socksColor: '#FFF', shoesColor: '#CE1141', shortsLength: 'short' },
        { id: 'human_malone', animal: 'human', name: 'Mailman', jerseyName: 'MAILMAN', cost: 30000, heightScale: 1.18, widthScale: 1.1, jerseyColor: '#753BBD', shortsColor: '#753BBD', sideStripesColor: '#00A9E0', number: '32', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'bald_clean', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        { id: 'human_stockton', animal: 'human', name: 'Assist King', jerseyName: 'ASSIST', cost: 30000, heightScale: 1.05, widthScale: 0.9, jerseyColor: '#753BBD', shortsColor: '#753BBD', sideStripesColor: '#00A9E0', number: '12', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'side_swept_fringe', hairColor: '#5D4037', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        { id: 'human_admiral', animal: 'human', name: 'The Admiral', jerseyName: 'ADMIRAL', cost: 35000, heightScale: 1.22, widthScale: 1.0, jerseyColor: '#FFF', shortsColor: '#FFF', trimColor: '#000', number: '50', numberColor: '#000', skinTone: '#3e271a', hairStyle: 'fade_box', hairColor: '#000', socksColor: '#000', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_ticket', animal: 'human', name: 'Big Ticket', jerseyName: 'TICKET', cost: 35000, heightScale: 1.21, widthScale: 0.85, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '5', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'bald_clean', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_payton', animal: 'human', name: 'The Glove', jerseyName: 'GLOVE', cost: 30000, heightScale: 1.08, widthScale: 0.95, jerseyColor: '#00653A', shortsColor: '#00653A', sideStripesColor: '#FFC200', number: '20', numberColor: '#FFC200', skinTone: '#3e271a', hairStyle: 'bald_clean', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_kemp', animal: 'human', name: 'Reign Man', jerseyName: 'REIGN', cost: 30000, heightScale: 1.18, widthScale: 1.05, jerseyColor: '#00653A', shortsColor: '#00653A', sideStripesColor: '#FFC200', number: '40', numberColor: '#FFC200', skinTone: '#3e271a', hairStyle: 'fade_high', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_human_film', animal: 'human', name: 'Human Film', jerseyName: 'FILM', cost: 30000, heightScale: 1.16, widthScale: 0.95, jerseyColor: '#E03A3E', shortsColor: '#E03A3E', trimColor: '#FFCD00', number: '21', numberColor: '#FFCD00', skinTone: '#3e271a', hairStyle: 'fade_box', hairColor: '#000', socksColor: '#FFF', shoesColor: '#E03A3E', shortsLength: 'short' },
        { id: 'human_worthy', animal: 'human', name: 'Big Game', jerseyName: 'BIG GAME', cost: 30000, heightScale: 1.17, widthScale: 0.95, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '42', numberColor: '#552583', skinTone: '#3e271a', hairStyle: 'glasses', headAccessory: 'glasses', hatColor: '#000', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        { id: 'human_pistol', animal: 'human', name: 'Pistol', jerseyName: 'PISTOL', cost: 30000, heightScale: 1.10, widthScale: 0.9, jerseyColor: '#002B5C', shortsColor: '#002B5C', trimColor: '#F9A01B', number: '7', numberColor: '#F9A01B', skinTone: '#f0d5be', hairStyle: 'shaggy_top', hairColor: '#5D4037', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },

        // NBA CURRENT (NEW)
        { id: 'human_tatum', animal: 'human', name: 'Taco Jay', jerseyName: 'TACO JAY', cost: 25000, heightScale: 1.17, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '0', numberColor: '#FFF', skinTone: '#8d5524', hairStyle: 'curly_top_fade', hairColor: '#000', beard: true, socksColor: '#FFF', shoesColor: '#007A33' },
        { id: 'human_butler', animal: 'human', name: 'Him', jerseyName: 'HIM', cost: 25000, heightScale: 1.15, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', trimColor: '#98002E', number: '22', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'dreads_tied', hairColor: '#000', beard: false, socksColor: '#000', shoesColor: '#98002E' },
        { id: 'human_ant', animal: 'human', name: 'Ant Man', jerseyName: 'ANT', cost: 25000, heightScale: 1.10, widthScale: 1.0, jerseyColor: '#0C2340', shortsColor: '#0C2340', trimColor: '#78BE20', number: '5', numberColor: '#78BE20', skinTone: '#3e271a', hairStyle: 'fade_low', hairColor: '#000', socksColor: '#000', shoesColor: '#78BE20' },
        { id: 'human_book', animal: 'human', name: 'Book', jerseyName: 'BOOK', cost: 25000, heightScale: 1.12, widthScale: 0.9, jerseyColor: '#1D1160', shortsColor: '#1D1160', trimColor: '#E56020', number: '1', numberColor: '#E56020', skinTone: '#dcb98a', hairStyle: 'fade_low', hairColor: '#000', socksColor: '#000', shoesColor: '#E56020', beard: true },
        { id: 'human_ja', animal: 'human', name: 'Grizzly', jerseyName: 'GRIZZLY', cost: 25000, heightScale: 1.08, widthScale: 0.85, jerseyColor: '#5D76A9', shortsColor: '#5D76A9', trimColor: '#FDB927', number: '12', numberColor: '#FDB927', skinTone: '#3e271a', hairStyle: 'dreads_short', hairColor: '#000', socksColor: '#5D76A9', shoesColor: '#FDB927' },
        { id: 'human_spida', animal: 'human', name: 'Spida', jerseyName: 'SPIDA', cost: 25000, heightScale: 1.06, widthScale: 0.95, jerseyColor: '#6F263D', shortsColor: '#6F263D', trimColor: '#FFB81C', number: '45', numberColor: '#FFB81C', skinTone: '#3e271a', hairStyle: 'fade_low', hairColor: '#000', socksColor: '#000', shoesColor: '#FFB81C', beard: true },
        { id: 'human_zion', animal: 'human', name: 'Zion', jerseyName: 'ZION', cost: 25000, heightScale: 1.14, widthScale: 1.2, armWidthScale: 1.2, legWidthScale: 1.2, jerseyColor: '#002B5C', shortsColor: '#002B5C', trimColor: '#E31837', number: '1', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'fade_low', hairColor: '#000', socksColor: '#FFF', shoesColor: '#E31837' },
        { id: 'human_trae', animal: 'human', name: 'Ice Trae', jerseyName: 'ICE', cost: 25000, heightScale: 1.05, widthScale: 0.8, jerseyColor: '#E03A3E', shortsColor: '#E03A3E', trimColor: '#C1D32F', number: '11', numberColor: '#C1D32F', skinTone: '#dcb98a', hairStyle: 'curly_top_fade', hairColor: '#000', socksColor: '#FFF', shoesColor: '#C1D32F', beard: true },
        { id: 'human_fox', animal: 'human', name: 'Swipa', jerseyName: 'SWIPA', cost: 25000, heightScale: 1.08, widthScale: 0.85, jerseyColor: '#5A2D81', shortsColor: '#5A2D81', trimColor: '#63727A', number: '5', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'braids_zigzag', hairColor: '#000', socksColor: '#000', shoesColor: '#5A2D81', beard: true },
        { id: 'human_bam', animal: 'human', name: 'Bam', jerseyName: 'BAM', cost: 25000, heightScale: 1.15, widthScale: 1.05, jerseyColor: '#000', shortsColor: '#000', trimColor: '#98002E', number: '13', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'afro_mini', hairColor: '#000', socksColor: '#000', shoesColor: '#98002E', beard: true }
    ];
