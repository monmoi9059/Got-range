    ...
    var ACHIEVEMENTS = [
        { id: 'rookie', name: 'Recrue', desc: 'Premier panier marqué', reward: 10 },
        { id: 'veteran', name: 'Vétéran', desc: 'Marquer 100 paniers au total', reward: 150 },
        ...
        { id: 'levis_legend', name: 'Lévis Legend', desc: 'Atteindre 150 pi', reward: 200 },
        ...
        { id: 'sweet_tooth', name: 'Bec Sucré', desc: 'Sirop Érable Niv 5', reward: 100 },
        { id: 'hawkeye', name: 'Oeil de Lynx', desc: 'Visée Assistée Niv 5', reward: 100 },
        { id: 'leprechaun', name: 'Chanceux', desc: 'Taco Grease Niv 5', reward: 100 },
        { id: 'fashionista', name: 'Fashionista', desc: 'Débloquer 5 skins', reward: 100 },
        { id: 'wardrobe_malfunction', name: 'Garde-robe Pleine', desc: 'Débloquer 10 skins', reward: 300 },
        { id: 'collector', name: 'Collectionneur', desc: 'Débloquer 15 skins', reward: 500 },
        { id: 'zoo', name: 'Gardien de Zoo', desc: 'Skins pour 3 animaux différents', reward: 150 },
        { id: 'lucky', name: 'Chance Pure', desc: 'Avoir un rebond chanceux', reward: 25 },
        { id: 'daredevil', name: 'Casse-cou', desc: 'Marquer en difficulté max', reward: 50 },
        { id: 'hard_mode', name: 'Travaillant', desc: 'Marquer en mode Difficile', reward: 25 },
        { id: 'cosplay', name: 'Cosplay', desc: 'Équiper Robot/Alien/Ninja', reward: 20 },
        { id: 'eh', name: 'Canadien', desc: 'Équiper Bûcheron ou Hockey', reward: 20 },
        { id: 'spooky', name: 'Effrayant', desc: 'Équiper Zombie/Vampire/Diable', reward: 20 },
        { id: 'urban_legend', name: 'Légende Urbaine', desc: 'Jouer sur le Terrain de Rue', reward: 50 },
        ...
        // STREAK ACHIEVEMENTS
        { id: 'streak_2', name: 'Le Début', desc: '2 paniers de suite', reward: 5, type: 'streak', threshold: 2 },
        ...
        { id: 'streak_25', name: 'Quart de Siècle', desc: '25 paniers de suite', reward: 150, type: 'streak', threshold: 25 },
        ...
        { id: 'streak_55', name: 'Vitesse de Croisière', desc: '55 paniers de suite', reward: 550, type: 'streak', threshold: 55 },
        { id: 'streak_60', name: 'Soixante', desc: '60 paniers de suite', reward: 600, type: 'streak', threshold: 60 },
        { id: 'streak_65', name: 'L\'Âge d\'Or', desc: '65 paniers de suite', reward: 650, type: 'streak', threshold: 65 },
        ...
        { id: 'streak_85', name: 'Inarrêtable', desc: '85 paniers de suite', reward: 850, type: 'streak', threshold: 85 },
        { id: 'streak_90', name: 'L\'Élite', desc: '90 paniers de suite', reward: 900, type: 'streak', threshold: 90 },
        { id: 'streak_95', name: 'Presque Là', desc: '95 paniers de suite', reward: 950, type: 'streak', threshold: 95 },
        ...
        { id: 'dist_3500', name: 'Kilomètre Vertical', desc: 'Atteindre 3500 pi', reward: 700, type: 'distance', threshold: 3500 },
        { id: 'dist_4000', name: 'Hélicoptère', desc: 'Atteindre 4000 pi', reward: 750, type: 'distance', threshold: 4000 },
        ...
        { id: 'dist_10000', name: 'Aviation Légère', desc: 'Atteindre 10000 pi', reward: 1200, type: 'distance', threshold: 10000 },
    ...
    var SKINS_DB = [
        ...
        { id: 'fake_link', animal: 'human', name: 'Elfe Héros', cost: 12000, heightScale: 1.0, widthScale: 0.95, jerseyColor: '#00A000', shortsColor: '#FFF', number: '', numberColor: '#000', skinTone: '#ffe0bd', hairStyle: 'long', hairColor: '#FFD700', headAccessory: 'wizard_hat', hatColor: '#00A000', socksColor: '#FFF', shoesColor: '#3c2415' },
        ...
        { id: 'human_anchor', animal: 'human', name: 'The Anchor', cost: 0, heightScale: 1.06, widthScale: 1.05, jerseyColor: '#800020', shortsColor: '#800020', legType: 'pants', sleeveColor: '#800020', hairStyle: 'pompadour', hairColor: '#5D4037', skinTone: '#f0d5be', shoesColor: '#333', pattern: 'suit_jacket' },
    ...
    var SHOOTING_STYLES = [
        ...
        { id: 'lebron', name: 'King James', cost: 0, desc: 'Tir puissant, recul léger.', modifiers: { jumpVelocity: 10.0, speed: 1.2 } },
        ...
        { id: 'shaq', name: 'Diesel', cost: 0, desc: 'Tir à une main rigide.', modifiers: { jumpVelocity: 6, speed: 1.1, timingWindow: 0.7 } },
        ...
        { id: 'ai', name: 'The Answer', cost: 0, desc: 'Armé très haut derrière la tête.', modifiers: { speed: 1.4, jumpVelocity: 10.0 } },
        ...
        { id: 'noah', name: 'Tornado', cost: 0, desc: 'La tornade à deux mains.', modifiers: { speed: 0.9, jumpVelocity: 8.0 } },
        { id: 'bol', name: 'Manute', cost: 0, desc: 'La catapulte géante.', modifiers: { speed: 0.7, jumpVelocity: 4.0 } },
...
let lastDisplayedContestTime = -1;
    ...
    function getReleaseTargetVz(maxVz) {
        // 0: Jump (Early) -> 75% of max velocity left
        // 1: Setpoint (Mid) -> 50%
        // 2: Push (Late-Mid) -> 25%
        // 3: Release (Apex) -> 0%
        const timing = (playerData.releaseTiming !== undefined) ? playerData.releaseTiming : 3;
        if (timing === 0) return maxVz * 0.75;
        if (timing === 1) return maxVz * 0.50;
        if (timing === 2) return maxVz * 0.25;
        return 0;
    }
    ...
    function drawShotMeter(cx, cy, radius, s, progress, greenStart, shape, greenEnd) {
        ...
        if (shape === 'vertical') {
            ...
            const sg = size * ((greenStart + greenEnd)/2);
            ctx.strokeStyle = 'rgba(0,255,0,0.5)'; ctx.lineWidth=2; ctx.strokeRect(-sg, -sg, sg*2, sg*2);
            ctx.restore();
        }
        else if (shape === 'ring') {
            ctx.lineWidth = 8 * s;
    ...
    function drawFlightTracker() {
        ...
        if (currentGameMode === 'CLASSIC') {
            ...
            ctx.fillText(`(Équivalent: ${scaleObj.name})`, canvas.width/2, y + 55);
        } else {
        ...
        ctx.fillText("⛹️", margin, lineY + 10); ctx.fillText("🏀", margin + lineLen, lineY + 10);
            ...
            if (seed > 0.6) {
             ...
             for(let r=0; r<rows; r++) {
                 for(let c=0; c<cols; c++) {
                     ...
                     const hx = (p.x - w/2) + (c * (w/cols)) + (Math.random()*5*s);
                     const hy = (p.y - h) + (r * (h/rows)) + (Math.random()*5*s);
                     // Random Shirt Color
                     const hue = Math.floor(Math.random() * 360);
                     ctx.fillStyle = `hsl(${hue}, 70%, 50%)`;
                     ctx.beginPath(); ctx.arc(hx, hy, 4*s, 0, Math.PI*2); ctx.fill(); // Head/Body blob

                     // Arms (Cheering)
                     if (Math.random() > 0.6) {
                         ctx.strokeStyle = ctx.fillStyle; ctx.lineWidth = 1.5*s;
                         ctx.beginPath(); ctx.moveTo(hx-3*s, hy); ctx.lineTo(hx-5*s, hy-6*s); ctx.stroke();
                         ctx.beginPath(); ctx.moveTo(hx+3*s, hy); ctx.lineTo(hx+5*s, hy-6*s); ctx.stroke();
                     }
                 }
             }
             ...
             if (type === 'landmark_pyramid') {
                 ...
                 if(type === 'landmark_building') {
                     ...
                     for(let i=0; i<20; i++) {
                         for(let j=0; j<4; j++) {
                             if(Math.random()>0.5) ctx.fillRect(p.x - w/2 + 10*s + j*30*s, p.y - h + 20*s + i*40*s, 15*s, 20*s);
                         }
                     }
                 } else {
                     // Needle Top
    ...
    function drawRealisticHuman(p, s, skinObj) {
        ...
        if (state === 'JUMPING') {
            ...
            // Meter Visualization Logic
            // The meter represents velocity from Max (Start) to 0 (Apex).
            // This is mapped to 0.0 -> 1.0.

            const curVz = getCurrentVz(); // Can be negative if falling, but meter is usually ascent.
            // Map velocity to progress [0, 1] where 0 is maxVz and 1 is 0.
            let progress = 1.0 - (curVz / maxVz);

            // Clamp progress for display, though if we allow late shots (falling), progress > 1.
            // For visual clarity, let's clamp 0-1 for now or allow slightly over?
            // User requested "Release Timing", so let's stick to 0-1 logic mostly.
            ...
            // Calculate Green Zone Position on the meter
            const targetVz = getReleaseTargetVz(maxVz);
            // If targetVz is maxVz (Jump), green zone is at 1 - 1 = 0.
            // If targetVz is 0 (Release), green zone is at 1 - 0 = 1.
            const greenCenter = 1.0 - (targetVz / maxVz);

            // Calculate Green Zone Width based on threshold
            const thresh = calculateShotThreshold();
            // Width in meter-space (0-1)
            // accuracy = |v - target| < thresh
            // v < target + thresh  AND v > target - thresh
            // meter = 1 - v/max
            // The "start" (lower bar value, higher visual) of green zone:
            // Corresponds to v = target + thresh? No, lower progress means higher velocity.
            // Start of Green Zone (Visual start) should be when progress reaches (center - width).
            // Actually `drawShotMeter` uses `greenStart` as the "threshold point" for simple bars.
            // But for orb/etc it might need a center.
            // Let's look at `drawShotMeter` again.
            // It expects `greenStart` as a value 0-1 where the green zone BEGINS?
            // Previous code: greenStart = 1.0 - (thresh / maxVz).
            // This assumed target was 0. So green zone was [1.0 - width, 1.0].
            // Now we want center at `greenCenter`.
            // So `greenStart` should be `greenCenter - (width/2)`? Or is it just the threshold?

            // Re-reading drawShotMeter:
            // "ctx.lineTo(x, y + h * (1-greenStart));" -> Draws green line at greenStart?
            // "ctx.arc(..., -Math.PI/2 + (Math.PI*2*greenStart), ...)" -> Draws green arc segment.

            // The previous logic for `greenStart` was: `1.0 - (thresh / maxVz)`.
            // This implies the green zone is [greenStart, 1.0].
            // So `greenStart` is the lower bound of the success window.

            // New logic: Success window is [greenCenter - width, greenCenter + width] (approx).
            // Width in Vz terms is `thresh`. In progress terms: `thresh / maxVz`.
            // So lower bound (visual start) is `greenCenter - (thresh / maxVz)`.
            // Let's pass this as `greenStart`.
            // Note: `drawShotMeter` might draw from `greenStart` to end?
            // If so, we might need to modify `drawShotMeter` to draw a centered zone or pass width.
            // But to avoid modifying `drawShotMeter` logic too much (which assumes "fill up to target"),
            // We can trick it or update it.
            // The `Orb` meter I just fixed draws: `ctx.arc(cx, cy, radius, -Math.PI/2 + (Math.PI*2*greenStart), -Math.PI/2 + Math.PI*2, false);`
            // This draws from `greenStart` to `1.0`.
            // This works for "Apex" release (Target 1.0).
            // But if Target is 0.5 (Setpoint), we want green zone at 0.5, NOT 0.5 to 1.0.

            // CONCLUSION: I MUST UPDATE `drawShotMeter` to support a target WINDOW, not just a "fill to top" threshold.
            // I will pass `greenCenter` and `greenWidth` instead of `greenStart`.
            // Or just pass `greenStart` and `greenEnd`.

            // Let's calculate them here:
            const greenWidth = thresh / maxVz;
            let gStart = greenCenter - greenWidth;
            let gEnd = greenCenter + greenWidth; // For visuals, maybe slight tolerance?

            // Clamp
            gStart = Math.max(0, gStart);
            gEnd = Math.min(1, gEnd);

            if (playerData.meterEnabled) {
                 // Hack: modifying the signature call. I need to update the function definition first.
                 // Wait, I can't update the function definition in this block.
                 // I will assume I updated `drawShotMeter` to accept (..., progress, greenStart, shape, greenEnd).
                 // For now, let's just pass them and fix the function in next step if needed.
                 // Actually, the current plan step is "Update Meter Rendering". I should update the function AND the call.
    ...
    function drawPlayer(p) {
        ...
        const drawSegmentedArm = (sx, sy, isRight, angle1, angle2) => {
            ...
            // Shoulder Joint
            if(!armFurry) drawJoint(sx, sy, 7*s*sizeMod.w * 0.5, thisUpperColor);
            ...
            if (thisForeColor === furColor && thisUpperColor !== furColor) {
                elbowColor = thisUpperColor; // Sleeve covers elbow
            } else if (thisUpperColor === furColor) {
                elbowColor = furColor;
            }
            if(!armFurry) drawJoint(elbow.x, elbow.y, 6*s*sizeMod.w * 0.5, elbowColor);
        ...
        const drawLowerLeg = (xTop, yTop, xBot, yBot, isRight) => {
             ...
             // Knee Joint
             if(!legFurry) drawJoint(xTop, yTop, 7*s*sizeMod.w * 0.5, thighColor);
        ...
        if (state === 'JUMPING') {
            ...
            let gStart = greenCenter - greenWidth;
            let gEnd = greenCenter + greenWidth;
            gStart = Math.max(0, gStart);
            gEnd = Math.min(1, gEnd);
    ...
    function handleMiss() {
        ...
        if(currentGameMode === 'CONTEST') {
            ...
            if (consecutiveMisses >= maxMisses) {
                feedback = "TERMINÉ !"; feedbackTimer = 60; state = 'GAMEOVER'; setTimeout(openShop, 1500);
            } else {
