    ...
    var SKINS_DB = [
        ...
        // NEW ADDITIONS
        { id: 'human_deadpool', animal: 'human', name: 'Mercenaire', cost: 15000, heightScale: 1.05, widthScale: 1.0, jerseyColor: '#FF0000', shortsColor: '#000', legType: 'pants', sleeveColor: '#FF0000', skinTone: '#FF0000', headAccessory: 'helmet', hatColor: '#FF0000', backProp: 'katanas', pattern: 'suit', shoesColor: '#000' },
        ...
        // NEW HUMANS
        { id: 'human_bouffon', animal: 'human', name: 'Bouffon Fou', cost: 20000, jerseyColor: '#800080', shortsColor: '#800080', legType: 'pants', skinTone: '#FFF', hairStyle: 'short', hairColor: '#00FF00', pattern: 'suit', shoesColor: '#000' },
        { id: 'human_iron', animal: 'human', name: 'Homme Fer', cost: 25000, jerseyColor: '#8B0000', shortsColor: '#8B0000', legType: 'pants', sleeveColor: '#8B0000', skinTone: '#FFD700', headAccessory: 'helmet', hatColor: '#8B0000', headDetail: 'visor', shoesColor: '#FFD700' },
        { id: 'human_spider', animal: 'human', name: 'Araignée', cost: 25000, jerseyColor: '#FF0000', shortsColor: '#0000FF', legType: 'tights', sleeveColor: '#FF0000', skinTone: '#FF0000', pattern: 'grid', shoesColor: '#FF0000', headAccessory: 'mask', hatColor: '#FF0000' },
        { id: 'human_hulk', animal: 'human', name: 'Géant Vert', cost: 20000, heightScale: 1.4, widthScale: 2.8, jerseyType: 'none', shortsColor: '#800080', shortsPattern: 'ripped', skinTone: '#32CD32', hairStyle: 'shaggy', hairColor: '#000', shoesColor: '#32CD32', armWidthScale: 1.5, legWidthScale: 1.5 },
...
let lastDisplayedContestTime = -1;
    ...
    function drawPlayer(p) {
        ...
        if (skin.includes('hulk')) {
            sizeMod.w *= 3.0; // Chest 3x larger as requested
            sizeMod.h *= 1.5;
        } else if (currentAnimal === 'human' && skinObj.jerseyType === 'none') {
            sizeMod.w *= 1.5;
            sizeMod.h *= 1.5;
        }
        ...
        if (skinObj.jerseyType === 'none' || skin.includes('hulk')) {
            shoulderBaseW *= 1.5;
        }
