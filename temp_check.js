    ...
    var SKINS_DB = [
        ...
        { id: 'human_magic', animal: 'human', name: 'Magic', jerseyName: 'MAGIC', cost: 30000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#FDB927', shortsColor: '#FDB927', sideStripesColor: '#552583', number: '32', numberColor: '#552583', skinTone: '#5c3a21', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short' },
        ...
        { id: 'human_bird', animal: 'human', name: 'Larry Legend', jerseyName: 'LEGEND', cost: 40000, heightScale: 1.170, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '33', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'short', hairColor: '#e3c179', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        ...
        { id: 'human_duncan', animal: 'human', name: 'Big Fundamental', jerseyName: 'FUNDAMENTAL', cost: 35000, heightScale: 1.200, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', trimColor: '#C4CED4', number: '21', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'short', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_rodman', animal: 'human', name: 'The Worm', jerseyName: 'WORM', shortsPattern: 'bulls', cost: 30000, heightScale: 1.140, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#000', trimColor: '#000', number: '91', numberColor: '#000', skinTone: '#3e271a', hairStyle: 'short', hairColor: '#00FF00', socksColor: '#FFF', shoesColor: '#FFF', shortsLength: 'short', tattoos: true },
        ...
        { id: 'human_giannis', animal: 'human', name: 'Greek Freak', jerseyName: 'FREAK', cost: 25000, heightScale: 1.200, widthScale: 0.98, jerseyColor: '#00471B', shortsColor: '#00471B', sideStripesColor: '#EEE1C6', number: '34', numberColor: '#EEE1C6', skinTone: '#4a3020', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_joker', animal: 'human', name: 'The Joker', jerseyName: 'JOKER', cost: 25000, heightScale: 1.200, widthScale: 1.1, armWidthScale: 1.1, legWidthScale: 1.1, jerseyColor: '#0E2240', shortsColor: '#0E2240', trimColor: '#FEC524', number: '15', numberColor: '#FEC524', skinTone: '#f0d5be', hairStyle: 'short', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_luka', animal: 'human', name: 'Luka Magic', jerseyName: 'MAGIC', cost: 25000, heightScale: 1.140, widthScale: 1.0, jerseyColor: '#00538C', shortsColor: '#00538C', sideStripesColor: '#B8C4CA', number: '77', numberColor: '#FFF', skinTone: '#f0d5be', hairStyle: 'short', hairColor: '#4a3020', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_kd', animal: 'human', name: 'Slim Reaper', jerseyName: 'REAPER', cost: 30000, heightScale: 1.200, widthScale: 0.85, armWidthScale: 0.8, legWidthScale: 0.8, jerseyColor: '#1D1160', shortsColor: '#1D1160', sideStripesColor: '#E56020', number: '35', numberColor: '#E56020', skinTone: '#3e271a', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#1D428A' },
        { id: 'human_harden', animal: 'human', name: 'The Beard', jerseyName: 'BEARD', cost: 25000, heightScale: 1.110, widthScale: 0.95, jerseyColor: '#CE1141', shortsColor: '#CE1141', sideStripesColor: '#FFF', number: '13', numberColor: '#FFF', skinTone: '#5c3a21', hairStyle: 'mohawk', hairColor: '#000', beard: true, beardColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        ...
        { id: 'human_russell', animal: 'human', name: 'Bill', jerseyName: 'BILL', cost: 50000, heightScale: 1.185, widthScale: 0.9, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '6', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'short', hairColor: '#000', beard: true, beardColor: '#ccc', socksColor: '#FFF', shoesColor: '#000', shortsLength: 'short' },
        { id: 'human_pip', animal: 'human', name: 'Pip', jerseyName: 'PIP', cost: 30000, heightScale: 1.160, widthScale: 0.9, jerseyColor: '#CE1141', shortsColor: '#CE1141', trimColor: '#000', number: '33', numberColor: '#000', skinTone: '#4a3020', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        { id: 'human_wade', animal: 'human', name: 'Flash', jerseyName: 'FLASH', cost: 30000, heightScale: 1.100, widthScale: 0.92, jerseyColor: '#000', shortsColor: '#000', sideStripesColor: '#98002E', number: '3', numberColor: '#FFF', skinTone: '#4a3020', hairStyle: 'short', hairColor: '#000', socksColor: '#000', shoesColor: '#000' },
        { id: 'human_reggie', animal: 'human', name: 'Reggie', jerseyName: 'REGGIE', cost: 25000, heightScale: 1.140, widthScale: 0.85, jerseyColor: '#002D62', shortsColor: '#002D62', pinstripesColor: '#FDB927', number: '31', numberColor: '#FDB927', skinTone: '#8d5524', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#FFF' },
        { id: 'human_tmac', animal: 'human', name: 'T-Mac', jerseyName: 'T-MAC', cost: 25000, heightScale: 1.160, widthScale: 0.9, jerseyColor: '#007DC5', shortsColor: '#007DC5', pinstripesColor: '#C4CED4', number: '1', numberColor: '#FFF', skinTone: '#3e271a', hairStyle: 'short', hairColor: '#000', socksColor: '#FFF', shoesColor: '#000' },
        ...
        { id: 'human_dame', animal: 'human', name: 'Dame Time', cost: 30000, heightScale: 1.04, widthScale: 0.95, jerseyColor: '#000', shortsColor: '#000', pinstripesColor: '#CE1141', number: '0', numberColor: '#CE1141', skinTone: '#5c3a21', hairStyle: 'short', hairColor: '#000', sleeveLeft: '#000', socksColor: '#000', shoesColor: '#000', tattoos: true },
        { id: 'human_tatum', animal: 'human', name: 'Taco Jay', cost: 30000, heightScale: 1.18, widthScale: 0.95, jerseyColor: '#007A33', shortsColor: '#007A33', trimColor: '#FFF', number: '0', numberColor: '#FFF', skinTone: '#dcb98a', hairStyle: 'short', hairColor: '#000', beard: true, socksColor: '#FFF', shoesColor: '#FFF', tattoos: true },
        ...
        { id: 'fake_kratos', animal: 'human', name: 'Spartiate', cost: 15000, heightScale: 1.15, widthScale: 1.2, jerseyType: 'none', shortsType: 'kilt', shortsColor: '#333', number: '', numberColor: '#000', skinTone: '#F0F0F0', hairStyle: 'beard', hairColor: '#333', beard: true, beardColor: '#333', pattern: 'spartan_tattoo', backProp: 'chaos_blades', headDetail: 'tattoo_stripe', socksColor: '#333', shoesColor: '#333' },
        ...
        // TURTLES
        { id: 'turtle_classic', animal: 'turtle', name: 'Tortue', cost: 1000, furColor: '#228B22', backAccessory: 'backpack', backColor: '#006400' },
        { id: 'turtle_ninja', animal: 'turtle', name: 'Ninja', cost: 5000, furColor: '#32CD32', headAccessory: 'headband', hatColor: '#0000FF', backProp: 'katanas', backAccessory: 'backpack', backColor: '#006400' },
    ...
    const ANIM_DATA = {
        ...
        soccer: {
            ready: { la: 2.5, ra: 0.6, lfa: 2.0, rfa: 1.0, w: 0 }, // Overhead
            set: { la: 2.8, ra: 0.3, lfa: 2.5, rfa: 0.5, w: 0 }, // Back
            release: { la: -1.5, ra: -1.6, lfa: 0.1, rfa: -0.1, w: 0 } // Throw
        },
        no_look: {
            ready: { la: 0.5, ra: 2.6, lfa: 1.5, rfa: -2.0, w: 0 },
            set: { la: -2.2, ra: -2.2, lfa: -0.5, rfa: -0.8, w: 0 },
        ...
        shot_put: {
            ready: { la: 0.5, ra: 2.0, lfa: 1.5, rfa: -2.5, w: 0 }, // Ball at neck
            set: { la: -1.0, ra: -1.0, lfa: -1.0, rfa: -2.8, w: 0 }, // Crouch
            release: { la: -2.0, ra: -1.5, lfa: -2.0, rfa: -0.5, w: 0 } // Push out
        },
        dab: {
            ready: { la: 0.5, ra: 2.5, lfa: 1.5, rfa: -2.0, w: 0 },
            set: { la: -2.0, ra: -2.0, lfa: -1.0, rfa: -1.0, w: 0 },
            release: { la: -0.5, ra: -2.5, lfa: 2.5, rfa: -0.5, w: 0 } // Dab pose
        },
        helicopter: {
            ready: { la: 3.0, ra: 3.0, lfa: 0, rfa: 0, w: 0 }, // Arms up
            set: { la: 0, ra: 0, lfa: 0, rfa: 0, w: 0 }, // Down
            release: { la: 3.0, ra: 3.0, lfa: 0, rfa: 0, w: 0 } // Up again
        },
        prayer: {
            ready: { la: -1.5, ra: -1.6, lfa: -1.0, rfa: -2.1, w: 0 }, // Hands clasped
            set: { la: -1.8, ra: -1.9, lfa: -1.0, rfa: -2.1, w: 0 }, // Look up
            release: { la: -2.0, ra: -2.1, lfa: -0.5, rfa: -2.6, w: 0 } // Reach up
        },
        spirit_bomb: {
            ready: { la: 2.5, ra: 0.6, lfa: 2.5, rfa: 0.6, w: 0 }, // Hands high V shape
            set: { la: 2.8, ra: 0.3, lfa: 2.8, rfa: 0.3, w: 0 }, // Charge
            release: { la: -1.5, ra: -1.6, lfa: -0.1, rfa: -0.1, w: 0 } // Throw down
        }
    };
...
let lastDisplayedContestTime = -1;
    ...
    function drawFuzzyLimb(x1, y1, x2, y2, width, color, scale, isFurry, seed = 1, endWidth = null) {
        ...
        // High Graphics: 3D Cylinder Shading (Perpendicular)
        if (playerData.graphics === 'HIGH') {
             ...
             // Tapered Shading
             const grad3d = ctx.createLinearGradient(0, -w1, 0, w1); // Approx gradient
             grad3d.addColorStop(0, 'rgba(0,0,0,0.4)');
             grad3d.addColorStop(0.4, 'rgba(255,255,255,0.15)'); // Highlight
             grad3d.addColorStop(1, 'rgba(0,0,0,0.4)');
        ...
        // Add shadow gradient overlay for depth (Axial)
        ctx.save();
    ...
    function drawAnatomicBody(cx, topY, w, h, scale, color, isFurry, seed = 1, options = {}, anchors = null) {
        ...
        if (isFurry) {
            // High Quality: Draw base gradient shape for volume
            if (playerData.graphics === 'HIGH') {
                 ctx.beginPath();
            ...
            // Patterns (Furry)
            if (options.skinObj && options.skinObj.pattern) {
                 const skinObj = options.skinObj;
                 const pattern = skinObj.pattern;
                 ctx.save();
                 ctx.beginPath();
                 ctx.moveTo(points[0].x, points[0].y);
                 ...
                 if (pattern === 'tiger_stripes' || pattern === 'zebra_stripes' || pattern === 'stripes') {
                    ctx.strokeStyle = (pattern === 'zebra_stripes') ? '#000' : '#000';
                    if(skinObj.id.includes('tabby')) ctx.strokeStyle = '#8B4513';
                    ctx.lineWidth = 3 * scale; ctx.lineCap = 'round';
                    for(let i=0; i<5; i++) {
                        const y = topY + (i / 5) * h + 10*scale;
                        ctx.beginPath(); ctx.moveTo(cx - w/2, y); ctx.quadraticCurveTo(cx - w/4, y + 5*scale, cx - 5*scale, y + 2*scale); ctx.stroke();
                        ctx.beginPath(); ctx.moveTo(cx + w/2, y); ctx.quadraticCurveTo(cx + w/4, y + 5*scale, cx + 5*scale, y + 2*scale); ctx.stroke();
                    }
                    ctx.lineWidth = 2 * scale; ctx.beginPath(); ctx.moveTo(cx, topY); ctx.lineTo(cx, topY + h); ctx.stroke();
                 }
                 else if (pattern === 'cow_spots' || pattern === 'spots' || pattern === 'leopard_spots') {
                    ctx.fillStyle = (skinObj.spotColor) ? skinObj.spotColor : '#000';
                    if (pattern === 'leopard_spots') {
                        for(let i=0; i<8; i++) {
                            const x = cx + (Math.random()-0.5) * w * 0.8; const y = topY + (Math.random()) * h * 0.9; const r = 4*scale + Math.random()*3*scale;
                            ctx.beginPath(); ctx.arc(x, y, r, 0, Math.PI*2); ctx.fill();
                            ctx.fillStyle = skinObj.furColor || '#D2B48C'; ctx.beginPath(); ctx.arc(x, y, r*0.6, 0, Math.PI*2); ctx.fill();
                            ctx.fillStyle = (skinObj.spotColor) ? skinObj.spotColor : '#000';
                        }
                    } else {
                        const numSpots = (pattern === 'cow_spots') ? 4 : 15;
                        for(let i=0; i<numSpots; i++) {
                            const sd = i * 137; const r1 = Math.sin(sd)*0.5 + 0.5; const r2 = Math.cos(sd)*0.5 + 0.5;
                            const sx = cx + (r1 - 0.5) * w; const sy = topY + r2 * h;
                            const rad = (pattern === 'cow_spots') ? 8*scale + r1*5*scale : 3*scale;
                            ctx.beginPath(); ctx.ellipse(sx, sy, rad, rad*0.8, r1*Math.PI, 0, Math.PI*2); ctx.fill();
                        }
                    }
                 }
                 ctx.restore();
            ...
            if (options.skinObj && options.skinObj.pattern && options.skinObj.pattern !== 'spartan_tattoo') {
                 const skinObj = options.skinObj;
                 const pattern = skinObj.pattern;
                 ctx.save();
                 ctx.clip();
    ...
    function drawRealisticHuman(p, s, skinObj) {
        ...
        // --- NAME & NUMBER (Layer 4.5 - On Jersey) ---
        // Name on Back (Strictly enforced for NBA Legends only via jerseyName property)
        if (skinObj.jerseyName) {
             const nameText = skinObj.jerseyName.toUpperCase();
             ctx.fillStyle = skinObj.numberColor || "#FFF";

             // Dynamic font sizing to prevent bleeding
             ...
             if (textW > maxW) {
                 ...
                 // Don't go too small, instead condense vertically or clip?
                 // Simple Scaling
                 ctx.save();
        ...
        if(skinObj.hairStyle === 'afro') {
        ...
        else if(skinObj.hairStyle === 'shaggy') {
             // Hulk Hair: Messy, jagged black mop
             ctx.fillStyle = skinObj.hairColor || '#000';

             // Base cap
             ctx.beginPath(); ctx.arc(p.x, headY, headRadius * 1.3, Math.PI, 0); ctx.fill();

             // Jagged Edges
             const numJags = 12;
             ctx.beginPath();
             for(let i=0; i<=numJags; i++) {
                 const angle = Math.PI + (i/numJags)*Math.PI;
                 const r = (i%2===0) ? headRadius * 1.5 : headRadius * 1.2;
                 const hx = p.x + Math.cos(angle) * r;
                 const hy = headY + Math.sin(angle) * r * 0.6; // Flattened
             ...
             // Top messy bits
             for(let i=0; i<5; i++) {
                 const tx = p.x + (Math.random()-0.5)*headRadius*1.5;
                 const ty = headY - headRadius + (Math.random()-0.5)*5*s;
                 ctx.beginPath();
                 ctx.moveTo(tx, ty);
                 ctx.lineTo(tx-5*s, ty-10*s);
                 ctx.lineTo(tx+5*s, ty-10*s);
                 ctx.fill();
             }
        }
        ...
        // Name on Back
        // Render name BEFORE number, so it's on the jersey.
        // Important: Both Name and Number are drawn on Layer 4 (Torso).
        // Head/Hair is Layer 6. So Hair covers these naturally.
        // However, if the name is drawn *too high* relative to headY, it might look weird?
        // But render order is:
        // 1. Arms
        // 2. Legs
        // 3. Neck
        // 4. Shorts
        // 5. Torso (Body + Jersey)
        // -> Name/Number drawn here
        // 6. Tail
        // 7. Head (and Hair)

        // Wait! In the code structure I see:
        // drawLowerLeg calls...
        // Tail...
        // Head...
        // Back Props...
        ...
        // Ah! "Name on Back" and "Number" are at the VERY END of drawPlayer/drawRealisticHuman!
        // This means they are drawn AFTER the Head (Step 6) and Hair!
        // That is why the name prints ON TOP of the hair.

        // FIX: We must NOT draw them here. We should draw them right after drawing the Jersey (Step 4).
        // But drawJersey is a function. We can just move this block up to Step 4.

        // ACTUALLY, I will delete this block here and move it to execute immediately after drawJersey.
    ...
    function drawLimbPattern(ctx, x1, y1, x2, y2, width, s, skinObj) {
        if (!skinObj || !skinObj.pattern) return;
        const pattern = skinObj.pattern;
        ...
        // Draw Stripes
        if (pattern === 'tiger_stripes' || pattern === 'zebra_stripes' || pattern === 'stripes') {
            ctx.strokeStyle = (skinObj.id.includes('tabby')) ? '#8B4513' : '#000';
            ctx.lineWidth = 2 * s;
            const len = Math.sqrt((x2-x1)**2 + (y2-y1)**2);
            const numStripes = Math.floor(len / (10*s));
            for(let i=1; i<numStripes; i++) {
                const x = i * (10*s);
                ctx.beginPath();
                ctx.moveTo(x, -width/2);
                ctx.quadraticCurveTo(x + 3*s, 0, x, width/2);
                ctx.stroke();
            }
        }
        else if (pattern === 'spots' || pattern === 'leopard_spots') {
             ctx.fillStyle = (skinObj.spotColor) ? skinObj.spotColor : '#000';
             const len = Math.sqrt((x2-x1)**2 + (y2-y1)**2);
             const numSpots = Math.floor(len / (8*s));
             for(let i=0; i<numSpots; i++) {
                 const x = i * (10*s) + Math.random()*5*s;
    ...
    function drawEar(ctx, p, headY, headRadius, s, side, animal, skinObj, furColor) {
        // side: -1 for left, 1 for right
        const earColor = furColor;
        const innerColor = 'rgba(0,0,0,0.1)';
        const earX = p.x + (side * headRadius * 0.8);
        const earY = headY - (headRadius * 0.5);

        ctx.fillStyle = earColor;

        if (['cat', 'tiger', 'lion'].includes(animal)) {
            ctx.beginPath();
            ctx.moveTo(earX - (10*s*side), earY);
            ctx.lineTo(earX + (2*s*side), earY - (15*s)); // Tip
            ctx.lineTo(earX + (10*s*side), earY + (5*s));
            ctx.fill();

            ctx.fillStyle = (skinObj.id.includes('pink') || animal === 'cat') ? '#FFC0CB' : innerColor;
            ctx.beginPath();
            ctx.moveTo(earX - (6*s*side), earY);
            ctx.lineTo(earX + (2*s*side), earY - (10*s));
            ctx.lineTo(earX + (6*s*side), earY + (2*s));
            ctx.fill();
        }
        else if (['dog', 'wolf', 'fox'].includes(animal)) {
             if (skinObj.id.includes('pug') || skinObj.id.includes('floppy')) {
                 ctx.beginPath();
                 ctx.moveTo(earX - (8*s*side), earY);
                 ctx.quadraticCurveTo(earX + (15*s*side), earY + (5*s), earX + (8*s*side), earY + (15*s));
                 ctx.quadraticCurveTo(earX, earY + (10*s), earX - (8*s*side), earY);
                 ctx.fill();
             } else {
                 const h = (animal === 'fox') ? 20*s : 15*s;
                 ctx.beginPath();
                 ctx.moveTo(earX - (8*s*side), earY + (5*s));
                 ctx.lineTo(earX + (3*s*side), earY - h);
                 ctx.lineTo(earX + (10*s*side), earY + (8*s));
                 ctx.fill();

                 ctx.fillStyle = innerColor;
                 if(animal === 'fox') ctx.fillStyle = '#FFF';
                 ctx.beginPath();
                 ctx.moveTo(earX - (4*s*side), earY + (5*s));
                 ctx.lineTo(earX + (3*s*side), earY - h + (5*s));
                 ctx.lineTo(earX + (6*s*side), earY + (8*s));
                 ctx.fill();
             }
        }
        else if (animal === 'bear' || animal === 'mouse' || animal === 'rat') {
            const r = (animal === 'mouse' || animal === 'rat') ? 12*s : 8*s;
            ctx.beginPath(); ctx.arc(earX, earY - r/2, r, 0, Math.PI*2); ctx.fill();
            ctx.fillStyle = (animal === 'rat' || animal === 'mouse') ? '#FFC0CB' : innerColor;
            ctx.beginPath(); ctx.arc(earX, earY - r/2, r*0.6, 0, Math.PI*2); ctx.fill();
        }
        else if (animal === 'rabbit') {
            const h = 35*s; const w = 8*s;
            const isFloppy = skinObj.id.includes('lop');
            ctx.save(); ctx.translate(earX, earY);
            if (isFloppy) ctx.rotate(side * 2.5); else ctx.rotate(side * 0.2);
            ctx.beginPath(); ctx.ellipse(0, -h/2, w, h/2, 0, 0, Math.PI*2); ctx.fill();
            ctx.fillStyle = '#FFC0CB';
            ctx.beginPath(); ctx.ellipse(0, -h/2, w*0.6, h/2 * 0.7, 0, 0, Math.PI*2); ctx.fill();
            ctx.restore();
        }
        else if (animal === 'pig') {
             ctx.beginPath(); ctx.moveTo(earX, earY);
             ctx.quadraticCurveTo(earX + (15*s*side), earY - (5*s), earX + (18*s*side), earY + (5*s));
             ctx.quadraticCurveTo(earX + (10*s*side), earY + (10*s), earX, earY + (5*s));
             ctx.fill();
        }
        else if (animal === 'cow' || animal === 'moose' || animal === 'giraffe') {
             ctx.beginPath(); ctx.ellipse(earX + (5*s*side), earY + (5*s), 8*s, 5*s, side*0.2, 0, Math.PI*2); ctx.fill();
        }
        else if (animal === 'elephant') {
            ctx.fillStyle = furColor;
            ctx.beginPath();
            ctx.moveTo(p.x + (10*s*side), headY - 5*s);
            ctx.bezierCurveTo(p.x + (35*s*side), headY - 15*s, p.x + (35*s*side), headY + 15*s, p.x + (12*s*side), headY + 10*s);
            ctx.fill();
        }
    }

    function drawAnimalHead(ctx, p, headY, headRadius, s, animal, skinObj, furColor, isFurry) {
        if(animal === 'moose') {
        ...
        if(animal === 'cow' && !skinObj.id.includes('baby')) {
             ctx.fillStyle = '#EEE';
        ...
        if(animal === 'giraffe') {
             ctx.strokeStyle = furColor; ctx.lineWidth = 4*s; ctx.lineCap = 'round';
             ctx.beginPath(); ctx.moveTo(p.x - 5*s, headY - 8*s); ctx.lineTo(p.x - 6*s, headY - 18*s); ctx.stroke();
             ctx.beginPath(); ctx.moveTo(p.x + 5*s, headY - 8*s); ctx.lineTo(p.x + 6*s, headY - 18*s); ctx.stroke();
             ctx.fillStyle = '#5D4037';
             ctx.beginPath(); ctx.arc(p.x - 6*s, headY - 18*s, 3*s, 0, Math.PI*2); ctx.fill();
             ctx.beginPath(); ctx.arc(p.x + 6*s, headY - 18*s, 3*s, 0, Math.PI*2); ctx.fill();
        }

        drawEar(ctx, p, headY, headRadius, s, -1, animal, skinObj, furColor);
        drawEar(ctx, p, headY, headRadius, s, 1, animal, skinObj, furColor);

        let headColor = furColor;
        if(animal === 'lion' && !skinObj.id.includes('scar')) {
             if(skinObj.id.includes('white')) headColor = '#EEE';
             else if(skinObj.id.includes('classic')) headColor = '#A0522D';
             else headColor = '#8B4513';
        }
        if(animal === 'penguin') headColor = '#000';
        if(skinObj.id.includes('alien')) headColor = '#32CD32';

        if (isFurry) {
            if(animal === 'lion' && !skinObj.id.includes('scar')) {
                 drawFuzzyCircle(p.x, headY, headRadius * 1.6, headColor, 61, s, true);
                 headColor = skinObj.furColor || '#D2B48C';
            }
            if (['cat', 'wolf', 'fox', 'tiger'].includes(animal)) {
                 drawFuzzyCircle(p.x, headY, headRadius, headColor, 60, s, true);
                 drawFuzzyCircle(p.x - headRadius*0.8, headY + headRadius*0.4, headRadius*0.4, headColor, 62, s, true);
                 drawFuzzyCircle(p.x + headRadius*0.8, headY + headRadius*0.4, headRadius*0.4, headColor, 63, s, true);
            } else if (animal === 'penguin') {
                 ctx.fillStyle = headColor;
                 ctx.beginPath(); ctx.arc(p.x, headY, headRadius, 0, Math.PI*2); ctx.fill();
            } else if (['cow', 'moose', 'pig'].includes(animal)) {
                 drawFuzzyCircle(p.x, headY, headRadius, headColor, 60, s, isFurry);
                 drawFuzzyCircle(p.x, headY + 5*s, headRadius * 0.9, headColor, 63, s, isFurry);
            } else {
                 drawFuzzyCircle(p.x, headY, headRadius, headColor, 60, s, true);
            }
        } else {
        ...
        if (['pig', 'bear', 'cow', 'moose', 'wolf', 'fox', 'dog'].includes(animal)) {
             const muzzleColor = (animal === 'pig') ? '#FFC0CB' : shadeColor(headColor, 10);
             if(isFurry) drawFuzzyCircle(p.x, headY + 5*s, headRadius * 0.4, muzzleColor, 65, s, true);
             else {
                 ctx.fillStyle = muzzleColor;
                 ctx.beginPath(); ctx.ellipse(p.x, headY + 5*s, headRadius * 0.4, headRadius * 0.35, 0, 0, Math.PI*2); ctx.fill();
             }
        }

        if(animal === 'lion' && !skinObj.id.includes('scar')) {
             ctx.fillStyle = '#8B4513';
             if(skinObj.id.includes('white')) ctx.fillStyle = '#EEE';
             if(skinObj.id.includes('classic')) ctx.fillStyle = '#A0522D';
        ...
        if(skinObj.pattern === 'tiger_stripes') {
             ...
             ctx.beginPath(); ctx.moveTo(p.x, headY - headRadius*0.9); ctx.lineTo(p.x, headY - headRadius*0.5); ctx.stroke();
             ctx.beginPath(); ctx.moveTo(p.x - 10*s, headY - headRadius*0.7); ctx.lineTo(p.x - 5*s, headY - headRadius*0.3); ctx.stroke();
             ctx.beginPath(); ctx.moveTo(p.x + 10*s, headY - headRadius*0.7); ctx.lineTo(p.x + 5*s, headY - headRadius*0.3); ctx.stroke();
        }
    ...
    function drawPlayer(p) {
        ...
        switch(currentAnimal) {
            ...
            case 'chicken': sizeMod = { w: 0.7, h: 0.7, head: 0.7, stance: 0.8, limbLen: 0.7, armWidth: 0.6, legWidth: 0.6 }; break;
            case 'frog': sizeMod = { w: 0.8, h: 0.7, head: 1.0, stance: 1.4, limbLen: 1.1, armWidth: 0.8, legWidth: 0.8 }; break;
            case 'turtle': sizeMod = { w: 1.1, h: 0.9, head: 0.9, stance: 1.2, limbLen: 0.6, armWidth: 1.2, legWidth: 1.2 }; break;
            case 'elephant': sizeMod = { w: 1.5, h: 1.3, head: 1.4, stance: 1.3, limbLen: 1.0, armWidth: 1.5, legWidth: 1.5 }; break;
            case 'dino': sizeMod = { w: 1.3, h: 1.3, head: 1.2, stance: 1.2, limbLen: 1.1 }; break;
            case 'zebra': sizeMod = { w: 1.2, h: 1.2, head: 1.1, stance: 1.1, limbLen: 1.1 }; break;
            case 'giraffe': sizeMod = { w: 1.2, h: 1.6, head: 1.0, stance: 1.2, limbLen: 1.5 }; break;
        }
        ...
        const neckWidth = 10 * s * (sizeMod.w || 1.0) * 0.6;
        ...
        const shoulderScale = (sizeMod.w || 1.0);
        ...
        const drawSegmentedArm = (sx, sy, isRight, angle1, angle2) => {
            ...
            // Upper Arm (Tapered)
            drawFuzzyLimb(sx, sy, elbow.x, elbow.y, 7*s*sizeMod.armWidth, thisUpperColor, s, armFurry, seedBase, 5*s*sizeMod.armWidth);

            // Arm Sleeve Upper Segment (Mid-Bicep to Elbow)
            if (activeSleeveColor) {
                const midX = (sx + elbow.x) / 2;
                const midY = (sy + elbow.y) / 2;
                drawFuzzyLimb(midX, midY, elbow.x, elbow.y, 6.2*s*sizeMod.armWidth, activeSleeveColor, s, false, seedBase, 5.2*s*sizeMod.armWidth);
            }

            let wrist = getJoint(elbow.x, elbow.y, foreArmLen, angle2);

            // Forearm (Tapered)
            drawFuzzyLimb(elbow.x, elbow.y, wrist.x, wrist.y, 5*s*sizeMod.armWidth, thisForeColor, s, activeSleeveColor ? false : armFurry, seedBase + 1, 3.5*s*sizeMod.armWidth);
        ...
        // Arms First (Layer 1) - Arms behind legs
        drawSegmentedArm(leftShoulderX, armY, false, leftArmAngle, leftForeArmAngle);
        drawSegmentedArm(rightShoulderX, armY, true, rightArmAngle, rightForeArmAngle);
        ...
        // Hip Joints
        if(!legFurry) {
            drawJoint(p.x - hipX, hipY, 7*s*sizeMod.legWidth * 0.7, thighColor, isMechanical);
            drawJoint(p.x + hipX, hipY, 7*s*sizeMod.legWidth * 0.7, thighColor, isMechanical);
        } else {
            drawFuzzyCircle(p.x - hipX, hipY, 7*s*sizeMod.legWidth * 0.7, thighColor, 10, s, true);
            drawFuzzyCircle(p.x + hipX, hipY, 7*s*sizeMod.legWidth * 0.7, thighColor, 30, s, true);
        }

        // Tapered Thighs (8 -> 5)
        drawFuzzyLimb(p.x - hipX, hipY, lKneeX, lKneeY, 8*s*sizeMod.legWidth, thighColor, s, legFurry, 1, 5*s*sizeMod.legWidth);
        drawFuzzyLimb(p.x + hipX, hipY, rKneeX, rKneeY, 8*s*sizeMod.legWidth, thighColor, s, legFurry, 3, 5*s*sizeMod.legWidth);

        // Calves & Socks/Shoes
        const drawLowerLeg = (xTop, yTop, xBot, yBot, isRight) => {
             const calfBaseColor = calfColor;

             // Draw Base Calf (Tapered 5 -> 3.5)
             drawFuzzyLimb(xTop, yTop, xBot, yBot, 5*s*sizeMod.legWidth, calfBaseColor, s, legFurry, isRight?4:2, 3.5*s*sizeMod.legWidth);

             // Paw / Foot (If no shoes)
             if (legFurry && !skinObj.shoesColor) {
                 const pawColor = calfBaseColor;
                 drawFuzzyCircle(xBot, yBot, 4.5*s, pawColor, isRight?50:60, s, true);
                 // Toes
                 for(let k=-1; k<=1; k++) {
                     drawFuzzyCircle(xBot + k*3*s, yBot + 4*s, 3*s, pawColor, isRight?51+k:61+k, s, true);
                 }
             }

             // Knee Joint (Radius 0.7)
             if(!legFurry) drawJoint(xTop, yTop, 7*s*sizeMod.legWidth * 0.7, thighColor, isMechanical);
             else drawFuzzyCircle(xTop, yTop, 6*s*sizeMod.legWidth * 0.7, thighColor, isRight?40:20, s, true);
        ...
        if(currentAnimal === 'rat') {
            ...
            // Left
            ctx.beginPath();
            ctx.moveTo(p.x - 10*s, headY - 5*s);
            ctx.bezierCurveTo(p.x - 35*s, headY - 15*s, p.x - 35*s, headY + 15*s, p.x - 12*s, headY + 10*s);
            ctx.fill();
            // Right
            ctx.beginPath();
            ctx.moveTo(p.x + 10*s, headY - 5*s);
            ...
            // Ears
            ctx.fillStyle = furColor;
            ctx.beginPath(); ctx.ellipse(p.x - 12*s, headY - 5*s, 5*s, 3*s, 0.2, 0, Math.PI*2); ctx.fill();
            ctx.beginPath(); ctx.ellipse(p.x + 12*s, headY - 5*s, 5*s, 3*s, -0.2, 0, Math.PI*2); ctx.fill();
        } else if (currentAnimal === 'human') {
            // Human Ears
            ctx.fillStyle = furColor;
        ...
        if (currentAnimal === 'cat' || currentAnimal === 'bear' || currentAnimal === 'frog') {
             // Wide Head
             if (isFurry) {
                 drawFuzzyCircle(p.x - 5*s, headY, headRadius, headColor, 60, s, true);
                 drawFuzzyCircle(p.x + 5*s, headY, headRadius, headColor, 61, s, true);
             } else {
                 ctx.fillStyle = headColor;
                 ctx.beginPath(); ctx.ellipse(p.x, headY, headRadius * 1.2, headRadius * 0.9, 0, 0, Math.PI*2); ctx.fill();
             }
             drawFuzzyCircle(p.x, headY, headRadius, headColor, 62, s, isFurry);
        }
             ...
             // Diamond / Tapered
             drawFuzzyCircle(p.x, headY - 5*s, headRadius * 1.0, headColor, 60, s, isFurry);
             drawFuzzyCircle(p.x, headY + 5*s, headRadius * 0.9, headColor, 64, s, isFurry);
        }
        else if (currentAnimal === 'penguin') {
             // Continuous
             ctx.fillStyle = headColor;
    ...
    function drawBackground(vpX, vpY, vpW, vpH) {
        ...
        for (let i = 0; i < renderDecors.length; i++) {
            const d = renderDecors[i];
    ...
    function createGameContext() {
        return {
            ...
            animState: { la: Math.PI/2 - 0.2, ra: Math.PI/2 + 0.2, lfa: Math.PI/2 - 0.1, rfa: Math.PI/2 + 0.1, w: 0 },
            animTarget: { la: 0, ra: 0, lfa: 0, rfa: 0, w: 0 },
            breathingPhase: 0,
