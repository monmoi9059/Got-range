...
def run():
    with sync_playwright() as p:
        ...
        # Equip a hat (e.g. Red Cap at index 1)
        ...
        page.screenshot(path="verification/human_hat_verification.png")
        print("Screenshot saved to verification/human_hat_verification.png")
